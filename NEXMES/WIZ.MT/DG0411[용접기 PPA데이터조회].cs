...
namespace WIZ.MT
{
    ...
    public partial class DG0411 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0411_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //    return;
                //}
                rtnDtTemp = helper.FillTable("USP_DG0411_S1", CommandType.StoredProcedure
