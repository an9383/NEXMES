...
namespace WIZ.MT
{
    ...
    public partial class DG0422 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0422_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "DXID", "측정 X번호", false, GridColDataType_emu.Double, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "DYID", "측정 Y번호", false, GridColDataType_emu.Double, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "DPOSX", "도면 X좌표", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "DPOSY", "도면 Y좌표", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "DTPZ", "높이데이터", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //    return;
                //}
                rtnDtTemp = helper.FillTable("USP_DG0422_S1", CommandType.StoredProcedure
