...
namespace WIZ.MT
{
    public partial class IFTABLE : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void IFTABLE_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(Grid1, "SEQ", "순서", true, GridColDataType_emu.VarChar, 60, 90, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(Grid1, "SpecCode", "규격코드", true, GridColDataType_emu.VarChar, 230, 280, Infragistics.Win.HAlign.Left, true, true);
                ...
                rtnDtTemp = db.FillTable("USP_IFTABLE_S1", CommandType.StoredProcedure
                                , db.CreateParameter("PCODE", "L1", DbType.String, ParameterDirection.Input));

                WIZ.Common.FillComboboxMaster(this.Cbo_TypeNo_H, rtnDtTemp, "TABLE_ID", "TABLE_NAME", null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sDATA_TYPE = DBHelper.nvlString(Cbo_TypeNo_H.Value);
                //string sSpecCode = DBHelper.nvlString(Cbo_SpecCode_H.Value);

                rtnDtTemp = helper.FillTable("USP_IFTABLE_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("PCODE", "S1", DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_TYPE_NO", sDATA_TYPE, DbType.String, ParameterDirection.Input));
        ...
        private void IFTABLE_Activated(object sender, EventArgs e)
        {
            ////2020-09-14 ADD
            //try
            //{
