...
namespace WIZ.MT
{
    public partial class UC_WorkCenterC : UserControl
    {
        ...
        public UC_WorkCenterC(Hashtable hashXAXIS, Hashtable hashYAXIS, Hashtable hashWCData)
        {
            InitializeComponent();
        ...
        public DataRow WCData
        {
            ...
            set
            {
                ...
                lblLineStatus.Text = Convert.ToString(DrWorkCenter["LASTLINESTATUS"]);
