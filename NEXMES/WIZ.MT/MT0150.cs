...
namespace WIZ.MT
{
    public partial class MT0150 : BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        ...
        UC_WorkCenterC[] UcWC = new UC_WorkCenterC[0];
        UC_WorkCenterC uc;
        ...
        public MT0150()
        {
            ...
            //btbManager.PopUpAdd(txtWorkCenterCode_H, txtWorkCenterName_H, "TBM0600Y", new object[] { cboPlantCode_H, "", "", "" }); //작업장 POP-UP
        ...
        #region < FORM EVENTS >
        private void MT0150_Load(object sender, EventArgs e)
        {
            #region < GRID >
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "PLANTCODE", "공장", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "PLANTNAME", "공장", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE", "공장코드", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid2, "PLANTNAME", "공장", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            {
                this.ShowDialog(Common.getLangText("사업장을 먼저 선택하세요.", "MSG"), Forms.DialogForm.DialogType.OK);
                return;
            }
            ...
            try
            {
                sPlantCode = Convert.ToString(cboPlantCode_H.Value); //공장                                
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    {
                        #region < 라인별 가동현황(모니터링) - TAB2 >

                        int wcCnt = rtnDtTemp.Rows.Count;

                        UcWC = new UC_WorkCenterC[wcCnt];
                    ...
                    {
                        #region < 라인별 가동현황(라인별 상세 현황) - TAB3 >
        ...
        private void MT0150_Deactivate(object sender, EventArgs e)
        {
            bStop = true;
        }

        private void MT0150_Activated(object sender, EventArgs e)
        {
        ...
        {
            uc = new UC_WorkCenterC(hashXAXIS, hashYAXIS, hashWCData);
            DoDragDrop(uc, DragDropEffects.Copy);
        }
