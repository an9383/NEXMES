...
namespace WIZ.MT
{
    ...
    public partial class DG0421 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0421_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "PXID", "측정 X번호", false, GridColDataType_emu.Double, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PYID", "측정 Y번호", false, GridColDataType_emu.Double, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PPOSX", "도면 X좌표", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PPOSY", "도면 Y좌표", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PTPX", "PA X데이터", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PTPY", "PA Y데이터", false, GridColDataType_emu.Float, 150, 100, Infragistics.Win.HAlign.Center, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //    return;
                //}
                rtnDtTemp = helper.FillTable("USP_DG0421_S1", CommandType.StoredProcedure
