...
namespace WIZ.MT
{
    ...
    public partial class DG0412 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0412_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //    return;
                //}
                rtnDtTemp = helper.FillTable("USP_DG0412_S1", CommandType.StoredProcedure
