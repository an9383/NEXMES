...
namespace WIZ.MT
{
    ...
    public partial class DG0403 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0403_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "JOBID", "LOTNO", false, GridColDataType_emu.Float, 180, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "RCPNAME", "레시피명", false, GridColDataType_emu.Float, 280, 100, Infragistics.Win.HAlign.Center, true, false);
                ...
                //_GridUtil.InitColumnUltraGrid(grid1, "SEQSTATE", "SEQ상태", false, GridColDataType_emu.Float, 180, 100, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid1, "SIDESTATE", "자재상태", false, GridColDataType_emu.Float, 180, 100, Infragistics.Win.HAlign.Center, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //    return;
                //}
                rtnDtTemp = helper.FillTable("USP_DG0403_S1", CommandType.StoredProcedure
