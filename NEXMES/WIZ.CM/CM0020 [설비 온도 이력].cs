...
namespace WIZ.CM
{
    public partial class CM0020 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void CM0020_Load(object sender, EventArgs e)
        {
            #region Grid Setting
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_CM0020_S1", CommandType.StoredProcedure
