...
namespace WIZ.CM
{
    public partial class CM0040 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void CM0040_Load(object sender, EventArgs e)
        {
            #region Grid Setting
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_CM0040_S1", CommandType.StoredProcedure
