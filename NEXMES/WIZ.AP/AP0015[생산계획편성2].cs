...
namespace WIZ.AP
{
    public partial class AP0015 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP0015_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                dtGrid = helper.FillTable("USP_AP0015_S1", CommandType.StoredProcedure
                ...
                dtGrid = helper.FillTable("USP_AP0015_S2", CommandType.StoredProcedure
                       , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input));
