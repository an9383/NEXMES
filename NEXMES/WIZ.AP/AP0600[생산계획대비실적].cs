...
namespace WIZ.AP
{
    public partial class AP0600 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void AP0600_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "STARTPLANDATE", "계획일자", false, GridColDataType_emu.YearMonthDay, 110, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "PLANNO", "계획번호", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "DEPTCODE", "팀구분", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sCartType = Convert.ToString(cboCarType.Value);

                dtTemp = helper.FillTable("USP_AP0600_S2N", CommandType.StoredProcedure
                                                          ...
                                                          , helper.CreateParameter("CarType", sCartType, DbType.String, ParameterDirection.Input));
