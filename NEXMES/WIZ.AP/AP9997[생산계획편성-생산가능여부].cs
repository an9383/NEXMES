...
namespace WIZ.AP
{
    public partial class AP9997 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP9997_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "REMINDQTY", "생산가능여부", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "PLANQTY", "생산계획수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Right, false, true, "#,###,###");
        ...
        private void BtnSum_Click(object sender, EventArgs e)
        {
            ...
            dtGrid3 = helper.FillTable("USP_AP0012_S4_PLUS", CommandType.StoredProcedure
                                               , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input));
