...
namespace WIZ.AP
{
    public partial class AP0019 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP0019_Load(object sender, EventArgs e)
        {
            GridInitialize();
        }
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                dtGrid = helper.FillTable("USP_AP0019_S1", CommandType.StoredProcedure
                ...
                //dtGrid = helper.FillTable("USP_AP0019_S2", CommandType.StoredProcedure
                //       , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                //            helper.ExecuteNoneQuery("USP_AP0019_D1", CommandType.StoredProcedure
                //            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                ...
                //            helper.ExecuteNoneQuery("USP_AP0019_I1", CommandType.StoredProcedure
                //            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                //            , helper.CreateParameter("AS_WORKCENTERCODE", sWCCD, DbType.String, ParameterDirection.Input)
                //            , helper.CreateParameter("AS_PLANNO", sPlanNo, DbType.String, ParameterDirection.Input)
                //            , helper.CreateParameter("AS_ORDERNO", sOrderNO, DbType.String, ParameterDirection.Input)
            ...
            if (btnLink.Text == "클릭시 조회")
            {
                ...
                try
                {
                    ...
                    if (sMethodCode2 == EnumMethod.ITEMCODE)
                    {
                        ...
                        dtGrid2 = helper.FillTable("USP_AP0019_S2", CommandType.StoredProcedure
                              , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input));
        ...
        private void AP0019_Shown(object sender, EventArgs e)
        {
            btnLink.Enabled = (((WIZ.MAIN.ZA0003)this.MdiParent).GetToolBarStatus("NewFunc"));
        }
    }
