    ...
    public partial class AP0115 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "POSEQNO", "발주순번", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid1, "TMPINGROUPNO", "발주그룹순번", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, false, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "LOTQTY", "출하수량", true, GridColDataType_emu.Double, 100, 130, Infragistics.Win.HAlign.Right, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "CLOSEFLAG", "완료여부", false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Left, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "SEQ", "수주순번", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "CUSTNAME", "고객사", false, GridColDataType_emu.VarChar, 150, 0, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "FRAMEID", "프레임ID", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Right, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "MASKID", "마스크ID", false, GridColDataType_emu.VarChar, 150, 0, Infragistics.Win.HAlign.Right, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "CONTRACTQTY", "수주수량", false, GridColDataType_emu.Double, 100, 0, Infragistics.Win.HAlign.Right, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "OUTQTY", "출하수량", false, GridColDataType_emu.Double, 150, 0, Infragistics.Win.HAlign.Right, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "NOWQTY", "재고", false, GridColDataType_emu.Double, 150, 0, Infragistics.Win.HAlign.Right, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "CLOSER", "완료자", false, GridColDataType_emu.VarChar, 140, 0, Infragistics.Win.HAlign.Center, true, false);
