...
namespace WIZ.AP
{
    public partial class AP0010 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP0010_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "LOTNO", "LOT", false, GridColDataType_emu.VarChar, 130, false, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ORDERQTY", "지시수량", false, GridColDataType_emu.VarChar, 100, true, true);
        ...
        public override void DoNew()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_AP0010_S2", CommandType.StoredProcedure
                          , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input));
                ...
                for (int iRow = 0; iRow < rtnDtTemp.Rows.Count; iRow++)
                {
                    ...
                    grid1.Rows[iRow].Cells["LOTNO"].Value = rtnDtTemp.Rows[iRow]["LOTNO"];
                ...
                foreach (DataRow drChange in dtChange.Rows)
                {
                    switch (drChange.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_AP0010_D1", CommandType.StoredProcedure
                          , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
        ...
        private void btnOrderCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    helper.ExecuteNoneQuery("USP_AP0010_COPY", CommandType.StoredProcedure
