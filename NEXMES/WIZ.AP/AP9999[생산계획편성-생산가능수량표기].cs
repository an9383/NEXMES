...
//   Made By      : 황인호
//   Description  : 생산가능수량 표기 (Grid5 , USP_AP0012_S6)
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.AP
{
    public partial class AP9999 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP9999_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 60, 0, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "DIFFCHK", "생산가능수량", false, GridColDataType_emu.VarChar, 60, 0, Infragistics.Win.HAlign.Center, true, false);

                grid3.DisplayLayout.Bands[0].Columns["ITEMCODE"].Header.Appearance.ForeColor = Color.LightSkyBlue;
                grid3.DisplayLayout.Bands[0].Columns["DIFFCHK"].Header.Appearance.ForeColor = Color.LightSkyBlue;
                ...
                //grid5
                //_GridUtil.InitializeGrid(grid4, true, true, false, "", false);
                //_GridUtil.InitColumnUltraGrid(grid5, "PLANTCODE",     "사업장",       false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left,   false, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "ITEMCODE",      "품목",         false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "ITEMNAME",      "품명",         false, GridColDataType_emu.VarChar, 200, 0, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "OPNAME",        "공정명",       false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "COMPONENT",     "하위품목",     false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "COMPONENTNAME", "하위품목명",   false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "COMPONENTQTY",  "소요수량",     false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid5, "NOWQTY",        "재고수량",     false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left,   true, false, "#,###,###");
                //_GridUtil.InitColumnUltraGrid(grid5, "REMIND",        "생산가능수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left,   true, false, "#,###,###");
        ...
        public override void DoNew()
        {
            ...
            try
            {
                ...
                if (grid4.IsActivate || grid3.IsActivate)
                {
                    ...
                    string sItemName = DBHelper.nvlString(grid2.ActiveRow.Cells["ITEMNAME"].Value);
                    string sUnitCode = DBHelper.nvlString(grid2.ActiveRow.Cells["UNITCODE"].Value);
        ...
        private void grid3_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            //    string sPlantCode = Convert.ToString(this.grid1.ActiveRow.Cells["PLANTCODE"].Value);       //공장코드
            //    string sConTractNo = Convert.ToString(this.grid1.ActiveRow.Cells["CONTRACTNO"].Value);       //공장코드
            //   // string sItemCode = Convert.ToString(this.grid3.ActiveRow.Cells["ITEMCODE"].Value);         //품목코드
            ...
            //    dtGrid4 = helper.FillTable("USP_AP0012_S6", CommandType.StoredProcedure
            //          , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
            //          , helper.CreateParameter("AS_CONTRACTNO", sConTractNo, DbType.String, ParameterDirection.Input));
            //         // , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input));
            ...
            //    {
            //        grid5.DataSource = dtGrid4;
            //        grid5.DataBinds(dtGrid4);
            //    }
            //}
            //catch (Exception ex)
            //{
        ...
        private void BtnSum_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dtGrid4.Rows.Count > 0)
                {
                    grid3.DataSource = dtGrid4;
                    grid3.DataBinds(dtGrid4);
                }
            }
            catch (Exception ex)
            {
