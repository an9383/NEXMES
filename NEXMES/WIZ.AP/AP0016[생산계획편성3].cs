...
namespace WIZ.AP
{
    public partial class AP0016 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP0016_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTSEQ", "수주SEQ", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PLANNO", "계획번호", false, GridColDataType_emu.VarChar, 110, 0, Infragistics.Win.HAlign.Center, true, false);

                _GridUtil.InitColumnUltraGrid(grid1, "FRAMEID", "프레임", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "MASKID", "마스크", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid2, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "SEQ", "수주SEQ", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "FRAMEID", "프레임", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "MASKID", "마스크", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "CONTRACTQTY", "수주량", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "CLOSEFLAG", "완료여부", false, GridColDataType_emu.YearMonthDay, 0, 0, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "CHK", "선택", false, GridColDataType_emu.CheckBox, 70, 100, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, false, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "ITEMTYPE", "품목유형", false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 60, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "CONTRACTQTY", "수주수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "REMINDQTY", "잔여수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "PLANQTY", "생산계획수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "NOWQTY", "재고수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "QTY_5", "완제품", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, true);
                //_GridUtil.InitColumnUltraGrid(grid3, "QTY_4", "코팅코어", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, false, true);
                //_GridUtil.InitColumnUltraGrid(grid3, "QTY_3", "성형코어", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, false, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid4, "PLANNO", "계획지시번호", false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "RECDATE", "계획지시일자", false, GridColDataType_emu.YearMonthDay, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid4, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid4, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 200, 0, Infragistics.Win.HAlign.Left, true, true);
                //_GridUtil.InitColumnUltraGrid(grid4, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Left, false, false);
                _GridUtil.InitColumnUltraGrid(grid4, "URGENT", "긴급", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "PLANQTY", "계획수량", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "SETQTY", "편성수량", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid4, "WORKQTY", "작업수량", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid4, "FRAMEID", "프레임", false, GridColDataType_emu.VarChar, 60, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "MASKID", "마스크", false, GridColDataType_emu.VarChar, 60, 0, Infragistics.Win.HAlign.Center, true, false);
        ...
        public override void DoNew()
        {
            ...
            try
            {
                ...
                if (grid4.IsActivate || grid3.IsActivate)
                {
                    ...
                    string sPlanqty = DBHelper.nvlString(grid3.ActiveRow.Cells["CONTRACTQTY"].Value);
                    ...
                    //this.grid4.ActiveRow.Cells["FRAMEID"].Value = this.grid2.ActiveRow.Cells["FRAMEID"].Value.ToString();
                    //this.grid4.ActiveRow.Cells["SHEETID"].Value = this.grid2.ActiveRow.Cells["SHEETID"].Value.ToString();
        ...
        public override void DoSave()
        {
            ...
            try
            {
                sCustCode = DBHelper.nvlString(grid1.ActiveRow.Cells["CUSTCODE"].Value);
                sDueDate = DBHelper.nvlString(grid1.ActiveRow.Cells["DUEDATE"].Value);
                string sCONTRACTNO = Convert.ToString(this.grid1.ActiveRow.Cells["CONTRACTNO"].Value);
                ...
                foreach (DataRow drChange in dtChange.Rows)
                {
                    switch (drChange.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            ...
                            sFrameID = grid2.ActiveRow.Cells["FRAMEID"].Value.ToString();
                            sMaskID = grid2.ActiveRow.Cells["MASKID"].Value.ToString();
                            ...
                            , helper.CreateParameter("AS_URGENT", DBHelper.nvlString(drChange["URGENT"]), DbType.String, ParameterDirection.Input)
                            , helper.CreateParameter("AS_USER", sUser, DbType.String, ParameterDirection.Input));
                            #endregion
                            break;
                    }
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            dtGrid3 = helper.FillTable("USP_AP0012_S4_ELECT", CommandType.StoredProcedure
                                               , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(grid1.Rows[0].Cells["PLANTCODE"].Value), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_ITEMCODE", Convert.ToString(this.grid1.ActiveRow.Cells["ITEMCODE"].Value).Trim(), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input));
            ...
            try
            {
                ...
                sPlantCode = Convert.ToString(this.grid1.ActiveRow.Cells["PLANTCODE"].Value);       //공장코드
                sSDate = string.Format("{0:yyyy-MM-dd}", cbo_STARTDATE_H.Value);
                sEDate = string.Format("{0:yyyy-MM-dd}", cbo_ENDDATE_H.Value);
                sItemCode = Convert.ToString(this.grid1.ActiveRow.Cells["ITEMCODE"].Value).Trim();
                ...
                dtGrid3 = helper.FillTable("USP_AP0012_S3", CommandType.StoredProcedure
                , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
                //, helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input));
                ...
                {
                    grid4.DataSource = dtGrid3;
                    grid4.DataBinds(dtGrid3);
                }
            }
            catch (Exception ex)
            {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            {
                if (DBHelper.nvlBoolean(grid3.Rows[iRow].Cells["CHK"].Value) == true)
                {
                    grid3.Rows[iRow].Cells["CHK"].Value = false;
                }
                else
                {
                    grid3.Rows[iRow].Cells["CHK"].Value = true;
                }
        ...
        private void BtnCheck_ADD_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int iRow = 0; iRow < grid3.Rows.Count; iRow++)
                {
                    if (DBHelper.nvlBoolean(grid3.Rows[iRow].Cells["CHK"].Value) == true)
                    {
                        string sItemCode = DBHelper.nvlString(grid3.Rows[iRow].Cells["ITEMCODE"].Value);
                        string sItemName = DBHelper.nvlString(grid3.Rows[iRow].Cells["ITEMNAME"].Value);
                        string sUnitCode = DBHelper.nvlString(grid3.Rows[iRow].Cells["UNITCODE"].Value);
                        string sPlanqty = DBHelper.nvlString(grid3.Rows[iRow].Cells["PLANQTY"].Value);
                        this.grid4.InsertRow();
                        ...
                        this.grid4.ActiveRow.Cells["PLANQTY"].Value = sPlanqty;
                        this.grid4.ActiveRow.Cells["FRAMEID"].Value = this.grid2.ActiveRow.Cells["FRAMEID"].Value.ToString();
                        this.grid4.ActiveRow.Cells["MASKID"].Value = this.grid2.ActiveRow.Cells["MASKID"].Value.ToString();
                        this.grid4.ActiveRow.Cells["RECDATE"].Value = DateTime.Now.ToString("yyyy-MM-dd");
                        this.grid4.ActiveRow.Cells["URGENT"].Value = 'N';
                    }
                }
