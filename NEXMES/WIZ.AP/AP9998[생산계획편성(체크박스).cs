...
namespace WIZ.AP
{
    public partial class AP9998 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP9998_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void BtnSum_Click(object sender, EventArgs e)
        {
            ...
            dtGrid3 = helper.FillTable("USP_AP9998_S4", CommandType.StoredProcedure
                                               , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input));
            ...
            try
            {
                for (int iRow = 0; iRow < grid3.Rows.Count; iRow++)
                {
                    if (DBHelper.nvlBoolean(grid3.Rows[iRow].Cells["CHK"].Value) == true)
                    {
                        ...
                        string sPlanqty = DBHelper.nvlString(grid3.Rows[iRow].Cells["CONTRACTQTY"].Value);
                        this.grid4.InsertRow();
        ...
        //            rtnDtTemp3 = helper.FillTable("USP_AP9998_S5", CommandType.StoredProcedure
        //                                      , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
        //                                      , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
        //                                      , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
        //                                      , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input));
