...
namespace WIZ.AP
{
    public partial class AP0020 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void AP0020_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        private void btn_PRINT_WM_Click(object sender, EventArgs e)
        {
            ...
            //AP0020_POP ap0020_pop = new AP0020_POP(sItemCode, sItemName, sBoxQty, PRODQTY, dr);
            //ap0020_pop.ShowDialog();
        }
