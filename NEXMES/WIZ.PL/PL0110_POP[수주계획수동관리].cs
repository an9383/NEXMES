...
namespace WIZ.PL
{
    public partial class PL0110_POP : WIZ.Forms.BaseMDIChildForm
    {
        ...
        private void PL0110_POP_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid4, "Mold", "금형명", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid5, "PLANCOUNT", "계획수량", true, GridColDataType_emu.VarChar, 70, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid5, "DAYCAPA", "일생산수량", true, GridColDataType_emu.VarChar, 70, 100, Infragistics.Win.HAlign.Center, true, false);
            ...
            //_GridUtil.InitColumnUltraGrid(grid5, "PLANMOLDCAVITY", "계획금형캐비티", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, true, true);
            ...
            dtp_STARTDATE.Value = DateTime.Today.AddDays(1);
            ...
            try
            {
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    grid5.DataBinds();
                    grid5.Columns["PLANCOUNT"].CellActivation = Activation.AllowEdit;
                }
                else
                {
        ...
        private void ultraButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < grid5.Rows.Count; i++)
                {
                    ...
                    if (Convert.ToInt32(grid5.Rows[i].Cells["PLANCOUNT"].Value) != 0 && Convert.ToString(grid5.Rows[i].Cells["PLANPART"].Value) != "")
                    {
                        if (Convert.ToString(grid5.Rows[i].Cells["PL_conPlanDate"].Value) == "")
                        {
                            grid5.Rows[i].Cells["PL_conPlanDate"].Value = 1;
                        }
