...
namespace WIZ.PL
{
    public partial class PL0300 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PL0300_Load(object sender, EventArgs e)
        {
            #region GRID SETTING  

            _GridUtil.InitializeGrid(this.grid1, true, true, false, "", false);

            _GridUtil.InitColumnUltraGrid(grid1, "PLA_LotNo",       "생산계획일",     true, GridColDataType_emu.VarChar,     130, 100, Infragistics.Win.HAlign.Center,   true, false); // 수주고유번호         
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_Gubun",       "구분",           true, GridColDataType_emu.VarChar,      80, 100, Infragistics.Win.HAlign.Center,   true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_Ho",          "호기",           true, GridColDataType_emu.VarChar,      50, 100, Infragistics.Win.HAlign.Center,   true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_Ton",         "Ton",            true, GridColDataType_emu.VarChar,      50, 100, Infragistics.Win.HAlign.Center,   true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_Vend",        "고객사",         true, GridColDataType_emu.VarChar,      70, 100, Infragistics.Win.HAlign.Center,   true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLv_PartName",    "제품명",         true, GridColDataType_emu.VarChar,     200, 100, Infragistics.Win.HAlign.Left,     true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLv_MoldName",    "금형명",         true, GridColDataType_emu.VarChar,     200, 100, Infragistics.Win.HAlign.Left,     true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_ChaSu",       "차수",           true, GridColDataType_emu.VarChar,      50, 100, Infragistics.Win.HAlign.Center,   true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLv_Material",    "원재료명",       true, GridColDataType_emu.VarChar,     200, 100, Infragistics.Win.HAlign.Left,     true, false); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_OrderQTY",    "계획수량",       true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Right,    true, false); // 발주일
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_JegoQTY",     "재고량",         true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Right,    true, false); // 발주일
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_LackQTY",     "부족량",         true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Right,    true, false); // 발주일
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_WPLQTY",      "누적샷수",       true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Right,    true, false); // 발주일
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_Approval",    "승인상태",       true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Center,   true, false); // 발주일
            _GridUtil.InitColumnUltraGrid(grid1, "PLA_ETC",         "비고",           true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Center,   true, false); // 발주일
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_PL0300", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_PL0300_TEST_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]),   DbType.String, ParameterDirection.Input)
