...
namespace WIZ.PL
{
    public partial class PL0110_POP2 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void BtnProd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    PL0110_POP_POP1 mbp = new PL0110_POP_POP1(txtCUSTCODE.Text);
        ...
        private void btnSAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //저장, 수정
                rtnDtTemp = helper.FillTable("USP_PL0110_POP2_OD0000_SAVE", CommandType.StoredProcedure
