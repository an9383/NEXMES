...
namespace WIZ.PL
{
    public partial class PL0011 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PL0011_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMCODE", "품목코드", true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품목명",   true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTQTY", "수주량",   true, GridColDataType_emu.VarChar,     100, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "ORDERQTY", "생산계획총량", true, GridColDataType_emu.VarChar,     150, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "NOWQTY",      "작업지시총량", true, GridColDataType_emu.VarChar,   100, 100, Infragistics.Win.HAlign.Right, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PL0011_S1", CommandType.StoredProcedure
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    grid1.Columns[3].Header.Caption = "생산계획총량";
                    grid1.Columns[4].Header.Caption = "작업지시총량";
                    ...
                    grid1.Columns[1].CellAppearance.TextHAlign = HAlign.Right;
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_PL0011_S2", CommandType.StoredProcedure
        ...
        private void grid1_DoubleClickCell(object sender, DoubleClickCellEventArgs e)
        {
            try
            {
                PL0011_POP mbp = new PL0011_POP(Convert.ToString(grid1.ActiveRow.Cells["OD_ITEMCODE"].Value),
