...
namespace WIZ.PL
{
    public partial class PL0011_POP : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < CONSTRUCTOR >
        public PL0011_POP(string ITEMCODE, string ITEMNAME)
        {
            InitializeComponent();
            sITEMCODE = ITEMCODE;
            sITEMNAME = ITEMNAME;
        ...
        #region < FORM LOAD >
        private void PL0011_POP_Load(object sender, EventArgs e)
        {
        ...
        private void INQUIRE()
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_PL0011_POP_S1", CommandType.StoredProcedure
        ...
        private void btn_SAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < grid1.Rows.Count; i++)
                {
                    ...
                    {
                        helper.ExecuteNoneQuery("USP_PL0011_POP_I", CommandType.StoredProcedure
