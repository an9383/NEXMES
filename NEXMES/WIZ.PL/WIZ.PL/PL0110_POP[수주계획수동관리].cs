...
namespace WIZ.PL
{
    public partial class PL0110_POP : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PL0110_POP_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_date",      "수주일자", true, GridColDataType_emu.VarChar, 80, 100,  Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "OD_VEND", "고객사코드", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_Vend",      "고객사",   true, GridColDataType_emu.VarChar, 80, 100,  Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_PartName",  "제품명",   true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_FixedDate", "납기일자", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_OrderQTY",  "발주수량", true, GridColDataType_emu.VarChar, 190, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PL2_Residual",  "수주잔량", true, GridColDataType_emu.VarChar, 70, 100,  Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid4, "PL_PartCode", "품목코드", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid5, "DAYCAPA", "일생산수량", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, true);
            ...
            grid5.DisplayLayout.Bands[0].Columns["PLANCOUNT"].Header.Appearance.ForeColor = Color.SkyBlue;
            grid5.DisplayLayout.Bands[0].Columns["DAYCAPA"].Header.Appearance.ForeColor = Color.SkyBlue;
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_PL0110_POP_S2", CommandType.StoredProcedure
            ...
            try
            {
                DSGrid1 = helper.FillDataSet("USP_PL0110_S1", CommandType.StoredProcedure
                ...
                {
                    DSGrid1 = helper.FillDataSet("USP_PL0110_POP_S3", CommandType.StoredProcedure
        ...
        private void grid3_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                DSGrid1 = helper.FillDataSet("USP_PL0110_MD_S1", CommandType.StoredProcedure
            ...
            try
            {
                ...
                for (int i = 0; i < grid5.Rows.Count; i++)
                {
                    ...
                    if (Convert.ToInt32(grid5.Rows[i].Cells["PLANCOUNT"].Value) != 0 && Convert.ToString(grid5.Rows[i].Cells["PLANPART"].Value) != "" && Convert.ToString(grid5.Rows[i].Cells["PLANMOLD"].Value) != "")
                    {
                        ...
                        {
                            rtnDtTemp = helper.FillTable("USP_PL0110_I", CommandType.StoredProcedure
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                DSGrid1 = helper.FillDataSet("USP_PL0110_POP_S1", CommandType.StoredProcedure
                ...
                DSGrid1 = helper.FillDataSet("USP_PL0110_S4", CommandType.StoredProcedure
                        , helper.CreateParameter("AS_PLANTCODE", LoginInfo.PlantCode, DbType.String, ParameterDirection.Input)
        ...
        private void dtp_STARTDATE_ValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PL0110_S5", CommandType.StoredProcedure
        ...
        private void ultraButton3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                PL0110_POP2 mbp = new PL0110_POP2();
