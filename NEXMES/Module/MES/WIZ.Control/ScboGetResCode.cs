...
{
    public class ScboGetResCode : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetResCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("ResType", (resType == null) ? "" : resType, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["ResCode"].Hidden = true;
