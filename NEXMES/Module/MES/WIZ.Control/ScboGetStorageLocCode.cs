...
{
    public class ScboGetStorageLocCode : UltraCombo
    {
        public string dbConfig;

        private string storageLocType;
        ...
        public string StorageLocType
        {
            get
            {
                return storageLocType;
            }
            set
            {
                storageLocType = value;
            }
        }

        public ScboGetStorageLocCode()
        {
            InitializeComponent();
        }
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetStorageLocCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("StorageLocType", (storageLocType == null) ? "" : storageLocType, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["STORAGELOCCODE"].Hidden = true;
        ...
        private void InitializeComponent()
        {
            ...
            base.DisplayMember = "STORAGELOCNAME";
            ...
            base.ValueMember = "STORAGELOCCODE";
