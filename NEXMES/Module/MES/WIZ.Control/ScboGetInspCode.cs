...
{
    public class ScboGetInspCode : UltraCombo
    {
        public string dbConfig;

        private string inspType;

        private string inspCase;
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetInspCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("InspType", (inspType == null) ? "" : inspType, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("InspCase", (inspCase == null) ? "" : inspCase, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["InspCode"].Hidden = true;
