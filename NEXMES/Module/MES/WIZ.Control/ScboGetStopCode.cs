...
{
    public class ScboGetStopCode : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetStopCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("StopType", (stopType == null) ? "" : stopType, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("StopClass", (stopClass == null) ? "" : stopClass, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["StopCode"].Hidden = true;
