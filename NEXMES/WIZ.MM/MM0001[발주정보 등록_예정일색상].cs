...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : MM0001
//   Form Name    : 발주정보 등록 _입고예정일 COLOR 변경
//   Name Space   : WIZ.MM
//   Created Date : 2018-03-19
//   Made By      : WIZCORE
//   Edited Date  : 
//   Edit By      :
//   Description  : 발주정보 관리 및 식별표 발행_입고예정일 COLOR 변경
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.MM
{
    public partial class MM0001 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM EVENT >
        private void MM0001_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >  
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "POQTY", "발주량(ⓐ)", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Right, true, true);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "INQTY", "입고량", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "TMPINQTY", "가입고량(ⓑ)", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "REINQTY", "입고잔량\r\n(ⓐ-ⓑ)", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "TMPINGROUPNO", "발행그룹번호", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMNAME", "품명", true, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "BAL_CNT", "LOT 수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "BAL_QTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "TEMP_CNT", "LOT 수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "TEMP_QTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "INSP_WA_CNT", "LOT 수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "INSP_WA_QTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "INSP_NG_CNT", "LOT 수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "INSP_NG_QTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "TOTINQTY_CNT", "LOT 수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "TOTINQTY_QTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid3, "LOTQTY", "수량", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Right, true, false);
            ...
            string asldkjas = DBHelper.nvlString(rtnDtTemp.Columns["CODE_NAME_ORG"]);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0001_S1"
                ...
                {
                    DateTime PLANINDATE = Convert.ToDateTime(rtnDtTemp.Rows[i]["PLANINDATE"]); //입고예정일
                    DateTime PLANINDATE2 = PLANINDATE.AddDays(-2); // 발주예정일 2일전


                    if (PLANINDATE.Date.CompareTo(DateTime.Now) < 0)
                    {
                        grid1.Rows[i].Appearance.ForeColor = Color.Green;
                    }
                    else if (PLANINDATE2.Date.CompareTo(DateTime.Now) < 0)
                    {
                        grid1.Rows[i].Appearance.ForeColor = Color.Red;
                    }
                    else
                    {
                        grid1.Rows[i].Appearance.ForeColor = Color.Black;
                    }
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            {
                                this.ClosePrgFormNew();
                                this.ShowDialog(Common.getLangText("발주정보 상태가 대기가 아닙니다. 삭제 할 수 없습니다.", "MSG"), Forms.DialogForm.DialogType.OK);
                                return;
                            }
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_MM0001_I1"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            {
                                this.ClosePrgFormNew();
                                this.ShowDialog(Common.getLangText("발주정보 상태가 대기가 아닙니다. 수정 할 수 없습니다.", "MSG"), Forms.DialogForm.DialogType.OK);
                                return;
                            }
        ...
        public override void DoImportExcel()
        {
            ...
            MM0000_EXCEL mm0000_excel = new MM0000_EXCEL();
            mm0000_excel.ShowDialog();
            ...
            try
            {
                if (e.Cell.Column.ToString() == "SAVEBUTTON")
                {
                    ...
                    if (sFinishFlag == "D" || sFinishFlag == "I")
                    {
                        ...
                        MM0001_POP mm0001_pop = new MM0001_POP(drRow[0]);
                        mm0001_pop.ShowDialog();
