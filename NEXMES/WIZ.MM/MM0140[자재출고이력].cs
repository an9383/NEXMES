...
namespace WIZ.MM
{
    public partial class MM0140 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void MM0140_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "OUTDATE", "출고일자", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WORKERID", "출고자명", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "FRWHCODE", "FROM 창고코드", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "FRSTORAGELOCCODE", "FROM 위치코드", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "출하고객", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTNAME", "출하고객명", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false);

                //_GridUtil.InitColumnUltraGrid(grid1, "WHCODE",           "TO 창고코드",   false, GridColDataType_emu.VarChar,  180, 100, Infragistics.Win.HAlign.Left,   true, false);
                //_GridUtil.InitColumnUltraGrid(grid1, "STORAGELOCCODE",   "TO 위치코드",   false, GridColDataType_emu.VarChar,  180, 100, Infragistics.Win.HAlign.Left,   true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "OUTQTY", "출고수량", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "OUTTYPE", "출고유형", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
                ...
                rtnDtTemp = _Common.GET_BM0000_CODE("OUTTYPE");  //출고유형
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "OUTTYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");

                cbo_STARTDATE_H.Value = DateTime.Now.AddDays(-300);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0140_S1", CommandType.StoredProcedure
