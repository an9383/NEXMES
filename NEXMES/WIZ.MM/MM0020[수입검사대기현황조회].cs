...
namespace WIZ.MM
{
    public partial class MM0020 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA > 
        ...
        #region < FORM LOAD >
        private void MM0020_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0020_S1", CommandType.StoredProcedure
