...
namespace WIZ.MM
{
    public partial class MM1020 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ 선언자 ]
        //그리드 객체 생성
        ...
        #region [ Form Load ]
        private void MM1020_Load(object sender, EventArgs e)
        {
            #region [ Grid1 셋팅 ]
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "STORAGELOCNAME", "저장위치명", false, GridColDataType_emu.VarChar, 120, 90, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "LOTQTY", "전산수량", false, GridColDataType_emu.VarChar, 100, 80, Infragistics.Win.HAlign.Right, true, false, "#,##0", null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM1020_S1", CommandType.StoredProcedure
