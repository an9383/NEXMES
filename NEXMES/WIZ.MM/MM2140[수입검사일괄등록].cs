...
namespace WIZ.MM
{
    public partial class MM2140 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void MM2140_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품명", true, GridColDataType_emu.VarChar, 140, 90, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE", "품목", true, GridColDataType_emu.VarChar, 140, 90, Infragistics.Win.HAlign.Center, false, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM2140_S1", CommandType.StoredProcedure
                ...
                try
                {
                    if (grid1.Rows[grid1rowNUM].Cells["CHK"].Value.ToString() == "1")
                    {
                        ...
                        if (chkLastInsp.Checked == true)
                        {
                            ...
                            if (string.IsNullOrEmpty(cbo_LOCCODE_H.Value.ToString().Trim()))
                            {
                                this.ShowDialog(Common.getLangText("적재위치를 선택해주세요.", "MSG"), Forms.DialogForm.DialogType.OK);
                                return;
                            }
                        ...
                        helper.ExecuteNoneQuery("USP_PD2030_I1", CommandType.StoredProcedure
                        ...
                        foreach (DataRow drRow2 in Grid2D.Rows)
                        {
                            ...
                            helper.ExecuteNoneQuery("USP_PD2030_I2", CommandType.StoredProcedure
                                                   , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(grid1.Rows[grid1rowNUM].Cells["PLANTCODE"].Value), DbType.String, ParameterDirection.Input)
                                                   , helper.CreateParameter("AS_BARCODE", BARCODE, DbType.String, ParameterDirection.Input)
                                                   , helper.CreateParameter("AS_ITEMCODE", DBHelper.nvlString(grid1.Rows[grid1rowNUM].Cells["ITEMCODE"].Value), DbType.String, ParameterDirection.Input)
        ...
        private void Grid2AddRow()
        {
            ...
            //{
            //    rtnDtTemp = helper.FillTable("USP_PD2030_S3", CommandType.StoredProcedure
            ...
            grid2DT = helper.FillTable("USP_PD2030_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", PlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_ITEMCODE", ItemCode, DbType.String, ParameterDirection.Input));
            //, helper.CreateParameter("AS_SEQ", i, DbType.Int16, ParameterDirection.Input)
        ...
        private void grid1_CellChange(object sender, CellEventArgs e)
        {
            ...
            if (chkAllSel.Checked)
            {
                ...
                {
                    if (grid1.Rows[i].Cells["PONO"].Value.ToString() == sPONO)
                    {
        ...
        private void cbo_WHCODE_H_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sWhCode = DBHelper.nvlString(cbo_WHCODE_H.Value);
