...
namespace WIZ.MM
{
    public partial class MM0700 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ 선언자 ]
        //그리드 객체 생성
        ...
        #region [ Form Load ]
        private void MM0700_Load(object sender, EventArgs e)
        {
            #region [ Grid1 셋팅 ]
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WHCODE", "창고코드", false, GridColDataType_emu.VarChar, 100, 70, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "WHNAME", "창고명", false, GridColDataType_emu.VarChar, 90, 90, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "STORAGELOCCODE", "저장위치코드", false, GridColDataType_emu.VarChar, 120, 70, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "STORAGELOCNAME", "저장위치명", false, GridColDataType_emu.VarChar, 100, 90, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMQTY", "품목수량", false, GridColDataType_emu.VarChar, 100, 80, Infragistics.Win.HAlign.Right, true, false, "#,##0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "STOCKQTY", "전산수량", false, GridColDataType_emu.VarChar, 100, 80, Infragistics.Win.HAlign.Right, true, false, "#,##0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "TAKINGQTY", "실사수량", false, GridColDataType_emu.VarChar, 100, 80, Infragistics.Win.HAlign.Right, true, false, "#,##0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "CHK", "선택", false, GridColDataType_emu.CheckBox, 80, 60, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "CLOSEYN", "반영여부", false, GridColDataType_emu.VarChar, 100, 70, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                if (rbtnTaking.Checked == true)
                {
                    ...
                    rtnDtTemp = helper.FillTable("USP_MM0700_S1", CommandType.StoredProcedure
        ...
        public override void DoSave()
        {
            ...
            {
                this.Focus();
                if (this.ShowDialog(Common.getLangText("원자재 재고 실사 등록을 하시겠습니까?", "MSG"), DialogForm.DialogType.YESNO) == System.Windows.Forms.DialogResult.Cancel)
                {
                    CancelProcess = true;
                    DoInquire();
                    return;
                ...
                for (int i = 0; i < this.grid1.Rows.Count; i++)
                {
                    if (Convert.ToString(grid1.Rows[i].Cells["CHK"].Value).ToUpper() == "TRUE")
                    {
                        ...
                        {
                            this.ClosePrgFormNew();
                            this.ShowDialog(Common.getLangText("실사일자와 반영일자가 다릅니다. 실사반영을 할 수 없습니다.", "MSG"), DialogForm.DialogType.OK);
                            DoInquire();
                            return;
                        }
                        ...
                        helper.ExecuteNoneQuery("USP_MM0700_I1"
