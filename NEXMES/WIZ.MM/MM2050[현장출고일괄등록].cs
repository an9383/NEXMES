...
namespace WIZ.MM
{
    public partial class MM2050 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        public MM2050()
        {
            ...
            btbManager.PopUpAdd(txt_STORAGELOCCODE_H, txt_STORAGELOCNAME_H, "BM0090", new object[] { cbo_PLANTCODE_H, txt_WHCODE_H, "", "" });
        ...
        #region  < FORM LOAD >
        private void MM2050_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM2050_S1", CommandType.StoredProcedure
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            base.DoSave();
            string WHCODE = DBHelper.nvlString(cbo_WHCODE_H.Value);
            string STORAGELOCCODE = DBHelper.nvlString(cbo_LOCCODE_H.Value);

            foreach (DataRow drRow1 in Grid1D.Rows)
            {

                string ASDAS = DBHelper.nvlString(drRow1["CHK"]);
                ...
                if (DBHelper.nvlString(drRow1["CHK"]) == "1")
                {
                    try
                    {
                        helper.ExecuteNoneQuery("USP_PD2050_I1"
                                                ...
                                                , helper.CreateParameter("AF_DVIQTY", DBHelper.nvlString(drRow1["LOTQTY"]), DbType.Int32, ParameterDirection.Input)
                                                ...
                                                , helper.CreateParameter("AS_STORAGELOCCODE", STORAGELOCCODE, DbType.String, ParameterDirection.Input)
