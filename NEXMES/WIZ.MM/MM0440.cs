...
namespace WIZ.MM
{
    public partial class MM0440 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region  < MM0440_Load >
        private void MM0440_Load(object sender, EventArgs e)
        {
            #region --- Grid Setting ---
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "STOCKQTY", "재고수량(A)", false, GridColDataType_emu.Double, 120, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "SAFESTOCK", "안전재고수량(B)", false, GridColDataType_emu.Double, 140, 100, Infragistics.Win.HAlign.Right, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MAXSTOCK", "적정재고수량", false, GridColDataType_emu.Double, 120, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "SHORTSTOCK", "과부족수량(A-B)", false, GridColDataType_emu.Double, 140, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0440_S1", CommandType.StoredProcedure
