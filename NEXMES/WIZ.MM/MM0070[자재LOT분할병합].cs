...
namespace WIZ.MM
{
    public partial class MM0070 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void MM0070_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMTYPE", "품목구분", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "CUSTCODE", "거래처코드", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "CUSTNAME", "거래처명", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "LOTSTATUS", "LOT상태", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "PONO", "발주번호", false, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "POSEQNO", "발주순번", false, GridColDataType_emu.VarChar, 70, 100, Infragistics.Win.HAlign.Center, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "WHCODE", "창고", false, GridColDataType_emu.VarChar, 170, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "STORAGELOCCODE", "저장위치", false, GridColDataType_emu.VarChar, 170, 100, Infragistics.Win.HAlign.Left, false, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0070_S1", CommandType.StoredProcedure
        ...
        private void grid2_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (this.grid2.Rows[i].Cells["CHK"].Value.ToString().ToUpper() == "TRUE" && (Convert.ToString(this.grid2.Rows[this.grid2.ActiveRow.Index].Cells["ITEMCODE"].Value) == OldItemCode))
                        {
        ...
        private void btn_LOTMERGER_H_Click(object sender, EventArgs e)
        {
            ...
            MM0070_POP2 mm0070_pop2 = new MM0070_POP2(this.cbo_PLANTCODE_H.Value.ToString(), this.grid2);
            mm0070_pop2.ShowDialog();
            DoInquire();
        }
        ...
        private void btn_LOTDIVISTION_B_Click(object sender, EventArgs e)
        {
            ...
            MM0070_POP1 mm0070_pop1 = new MM0070_POP1(drRow[i]);
            mm0070_pop1.ShowDialog();
        }
        #endregion
        ...
        private void GetWhCode()
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_MM0070_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_WHTYPE", "WH001", DbType.String, ParameterDirection.Input));
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_MM0070_S2", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
