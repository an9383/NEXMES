...
namespace WIZ.WM
{
    public partial class WM0040 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA > 
        ...
        #region < FORM LOAD >
        private void WM0040_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "SEQNO", "차수", true, GridColDataType_emu.VarChar, 50, 100, Infragistics.Win.HAlign.Center, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_WM0040_S1", CommandType.StoredProcedure
