...
namespace WIZ.WM
{
    public partial class PD4050 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private string gPackNum = string.Empty;
        ...
        #region < FORM LOAD >
        private void PD4050_Load(object sender, EventArgs e)
        {
            txtInputBarCode.Select();
            //txtInputPackNum.Select();
        ...
        {
            txtInputPackNum.Text = string.Empty;
        ...
        private void ScanLogic()
        {
            try
            {
                ...
                _dt = USP_PD4050_S1(gBarCode, ref RS_CODE, ref RS_MSG);
        ...
        private void ScanLogic2()
        {
            try
            {
                gPackNum = txtInputPackNum.Text;

                if (gPackNum == string.Empty) return;
                ...
                DataTable _dt = new DataTable();
                _dt = USP_PD4050_S3(gPackNum, ref RS_CODE, ref RS_MSG);
                ...
                if (RS_CODE == "S")
                {
                    ...
                    {
                        sPackNum = Convert.ToString(_dt.Rows[0]["PACKNO"]);
                        sLotNo = Convert.ToString(_dt.Rows[0]["LOTNO"]);
                        sItemCode = Convert.ToString(_dt.Rows[0]["ITEMCODE"]);
                        sItemName = Convert.ToString(_dt.Rows[0]["ITEMNAME"]);
                        sQty = Convert.ToString(_dt.Rows[0]["QTY"]);
                        sUnitCode = Convert.ToString(_dt.Rows[0]["UNITCODE"]);
        ...
        private DataTable USP_PD4050_S1(string sBarCode, ref string RS_CODE, ref string RS_MSG)
        {
            DBHelper helper = new DBHelper(false);

            try
            {
                rtnDtTemp = helper.FillTable("USP_PD4050_S1"
        ...
        private DataTable USP_PD4050_S3(string sPackNum, ref string RS_CODE, ref string RS_MSG)
        {
            DBHelper helper = new DBHelper(false);

            try
            {
                rtnDtTemp = helper.FillTable("USP_PD4050_S3"
                                            , CommandType.StoredProcedure
                                            , helper.CreateParameter("AS_PLANTCODE", LoginInfo.PlantCode, DbType.String, ParameterDirection.Input)
                                            , helper.CreateParameter("AS_PACKNUM", sPackNum, DbType.String, ParameterDirection.Input));
        ...
        private void USP_PD4050_I1(string sBarCode, string sItemCode, string sCustCode, ref string RS_CODE, ref string RS_MSG)
        {
            DBHelper helper = new DBHelper(false);
        ...
        private bool AskRelease(string sLotNo)
        {
            ...
            {
                DataTable rtnDtTemp = new DataTable();
                rtnDtTemp = helper.FillTable("USP_PD4050_S2", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", LoginInfo.PlantCode, DbType.String, ParameterDirection.Input)
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                USP_PD4050_I1(gBarCode, sItemCode, sCustCode, ref RS_CODE, ref RS_MSG);
