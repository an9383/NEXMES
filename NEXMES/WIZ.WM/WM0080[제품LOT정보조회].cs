...
namespace WIZ.WM
{
    public partial class WM0080 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA > 
        ...
        #region < FORM LOAD >
        private void WM0080_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LOTNO", "LOTNO", true, GridColDataType_emu.VarChar, 130, 90, Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LOTBASEQTY", "수량", true, GridColDataType_emu.Double, 80, 130, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "LOTQTY", "수량", true, GridColDataType_emu.Double, 80, 130, Infragistics.Win.HAlign.Right, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE", "단위", true, GridColDataType_emu.VarChar, 60, 130, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INSPDATE", "검사일자", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Center, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INSPRESULT", "검사결과", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Center, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "INDATE", "입고일자", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "OUTDATE", "출고일자", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "LOTSTATUS", "LOT 상태", true, GridColDataType_emu.VarChar, 120, 130, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "WHCODE", "창고코드", true, GridColDataType_emu.VarChar, 160, 130, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "STORAGELOCCODE", "위치코드", true, GridColDataType_emu.VarChar, 160, 130, Infragistics.Win.HAlign.Left, true, false);
            ...
            rtnDtTemp = _Common.GET_BM0090_CODE("");  //창고위치코드
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("LOTSTATUS", "RELCODE1 = 'W'");     //사용여부
            WIZ.Common.FillComboboxMaster(this.cbo_LOTSTATUS_H, rtnDtTemp, rtnDtTemp.Columns["CODE_ID"].ColumnName, rtnDtTemp.Columns["CODE_NAME"].ColumnName, "ALL", "");
            ...
            cbo_STARTDATE_H.Value = DateTime.Now.AddDays(-10);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sLotStatus = DBHelper.nvlString(cbo_LOTSTATUS_H.Value);

                rtnDtTemp = helper.FillTable("USP_WM0080_S1", CommandType.StoredProcedure
                                                                    ...
                                                                    , helper.CreateParameter("AS_LOTSTATUS", sLotStatus, DbType.String, ParameterDirection.Input));
