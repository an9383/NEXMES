...
namespace WIZ.WM
{
    public partial class PD4120 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PD4120_Load(object sender, EventArgs e)
        {
        ...
        private void ScanLogic()
        {
            try
            {
                ...
                _dt = USP_PD4130_S1(gBarCode, ref RS_CODE, ref RS_MSG);
        ...
        private DataTable USP_PD4130_S1(string sBarCode, ref string RS_CODE, ref string RS_MSG)
        {
            DBHelper helper = new DBHelper(false);

            try
            {
                rtnDtTemp = helper.FillTable("USP_PD4130_S1"
        ...
        private void USP_PD4130_I1(string sBarCode, string sItemCode, string sCustCode, ref string RS_CODE, ref string RS_MSG)
        {
            DBHelper helper = new DBHelper(false);

            try
            {
                helper.ExecuteNoneQuery("USP_PD4130_I1"
                                       , CommandType.StoredProcedure
                                       , helper.CreateParameter("AS_PLANTCODE", LoginInfo.PlantCode, DbType.String, ParameterDirection.Input)
                                       , helper.CreateParameter("AS_BARCODE", sBarCode, DbType.String, ParameterDirection.Input)
        ...
        private bool AskRelease(string sLotNo)
        {
            ...
            {
                DataTable rtnDtTemp = new DataTable();
                rtnDtTemp = helper.FillTable("USP_PD4130_S2", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", LoginInfo.PlantCode, DbType.String, ParameterDirection.Input)
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                USP_PD4130_I1(gBarCode, sItemCode, sCustCode, ref RS_CODE, ref RS_MSG);
