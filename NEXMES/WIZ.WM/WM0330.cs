...
namespace WIZ.WM
{
    public partial class WM0330 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region  < WM0330_Load >
        private void WM0330_Load(object sender, EventArgs e)
        {
            #region --- Grid Setting ---
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_WM0330_S1", CommandType.StoredProcedure
