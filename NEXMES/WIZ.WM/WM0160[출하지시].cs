...
namespace WIZ.WM
{
    public partial class WM0160 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void WM0160_Load(object sender, EventArgs e)
        {
            GridInitialize();
        }
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "CHK", "선택", false, GridColDataType_emu.CheckBox, 60, 10, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid3, "SELOUTNO", "출하지시번호", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "RECDATE", "출하계획일자", false, GridColDataType_emu.YearMonthDay, 100, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "ENDDATE", "출하완료날짜", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "SHIPTYPE", "출하구분", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "CUSTCODE", "고객번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "CUSTNAME", "고객사", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "ADDRESS", "주소", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "USERINFO", "담당자", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "PHONE", "전화번호", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "TO_DATE", "도착요청일시", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid3, "REMARK", "비고", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Left, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "SELOUTNO", "출하지시번호", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 110, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "CONTRACTSEQ", "수주순번", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "INVOICENO", "IV번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "PLANQTY", "계획수량", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid2, "SHIPQTY", "실제수량", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "CUSTCODE", "고객번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid2, "CUSTNAME", "고객사", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, false, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "REMARK", "비고", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "SEQ", "수주순번", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "SELOUTNO", "출하지시번호", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTQTY", "수주수량", false, GridColDataType_emu.Double, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "고객번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTNAME", "고객사", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "OUTQTY", "출하수량", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "NOWQTY", "재고", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CLOSEFLAG", "완료여부", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, false, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "DUEDATE", "예정일자", false, GridColDataType_emu.YearMonthDay, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CLOSEDATE", "완료일자", false, GridColDataType_emu.YearMonthDay, 80, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CLOSER", "완료자", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "REMARK", "비고", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);

                _GridUtil.SetInitUltraGridBind(grid1);

                //필수입력 항목에 대한 음영
                grid2.DisplayLayout.Bands[0].Columns["PLANQTY"].Header.Appearance.ForeColor = Color.SkyBlue;


                #region --- Combobox & Popup Setting ---
                cbo_STARTDATE_H.Value = DateTime.Now.AddDays(-2);
                cbo_ENDDATE_H.Value = DateTime.Now;
                cbo_STARTDATE2_H.Value = DateTime.Now.AddDays(-2);
                ...
                UltraGridUtil.SetComboUltraGrid(this.grid3, "SHIPTYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");
                ...
                bizGridManager2 = new BizGridManager(this.grid2);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                /*dtGrid = helper.FillTable("USP_WM0160_S3", CommandType.StoredProcedure
                       , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_CONTRACTNO", "", DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                       , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
            ...
            try
            {
                ...
                if (grid2.ActiveRow != null)
                {
                    ...
                    if (grid1.ActiveRow != null)
                    {
                        ...
                        {
                            if (CModule.ToString(grid2.Rows[iRow].Cells["ITEMCODE"].Value) == sItemCode)
                            {
                                bselect2 = true;
                            }
                        }
                        ...
                        if (!bselect2)
                        {
                            ...
                            this.grid2.ActiveRow.Cells["CUSTCODE"].Value = sCustCode;
                            this.grid2.ActiveRow.Cells["CUSTNAME"].Value = sCustName;
                            this.grid2.ActiveRow.Cells["CONTRACTNO"].Value = sContractNo;
                            this.grid2.ActiveRow.Cells["CONTRACTSEQ"].Value = sContractSeq;
                ...
                else
                {
                    ...
                    {
                        if (CModule.ToString(grid3.Rows[iRow].Cells["SELOUTNO"].Value) == "[ NEW SHIP ]")
                        {
                            bselect = true;
                        }
                    }
                    ...
                    if (!bselect)
                    {
                        ...
                        this.grid3.ActiveRow.Cells["SHIPTYPE"].Value = "A";
                        this.grid3.ActiveRow.Cells["RECDATE"].Value = string.Format("{0:yyyy-MM-dd}", this.cbo_NEWORDERDATE_H.Value);
                        this.grid3.ActiveRow.Cells["CONTRACTNO"].Value = sContractNo;
                        grid3.ActiveRow.Cells["ENDDATE"].Activation = Activation.NoEdit;
                        grid3.ActiveRow.Cells["CONTRACTNO"].Activation = Activation.NoEdit;
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            this.grid3.ActiveRow.Cells["CUSTCODE"].Value = dt.Rows[0]["CUSTCODE"];
                            this.grid3.ActiveRow.Cells["CUSTNAME"].Value = dt.Rows[0]["CUSTNAME"];
                            this.grid3.ActiveRow.Cells["ADDRESS"].Value = dt.Rows[0]["ADDRESS"];
                            this.grid3.ActiveRow.Cells["USERINFO"].Value = dt.Rows[0]["ASGNNAME"];
                            this.grid3.ActiveRow.Cells["PHONE"].Value = dt.Rows[0]["ASGNSPHONE"];
                            this.grid3.ActiveRow.Cells["TO_DATE"].Value = DateTime.Now.ToString("yyyy-MM-dd");
                        }
                    ...
                    this.grid2.ActiveRow.Cells["CONTRACTNO"].Value = sContractNo;
                    this.grid2.ActiveRow.Cells["CONTRACTSEQ"].Value = sContractSeq;
                    this.grid2.ActiveRow.Cells["PLANQTY"].Value = "1";
                    this.grid2.ActiveRow.Cells["ITEMCODE"].Value = sItemCode;
                    this.grid2.ActiveRow.Cells["ITEMNAME"].Value = sItemName;
                    this.grid2.ActiveRow.Cells["UNITCODE"].Value = sUnitCode;
                    grid2.UpdateData();
                ...
                if (dtChange2 != null)
                {
                    ...
                    foreach (DataRow drChange2 in dtChange2.Rows)
                    {
                        switch (drChange2.RowState)
                        {
                            ...
                            case DataRowState.Modified:
                                #region -- 추가/수정 --
                                sSelOutNo = sRT_SelOutNo == "" ? DBHelper.nvlString(grid3.ActiveRow.Cells["SELOUTNO"].Value) : sRT_SelOutNo;
                                sSoNoDate = string.Format("{0:yyyy-MM-dd}", cbo_NEWORDERDATE_H.Value);
                                sPlantCode = DBHelper.nvlString(cbo_PLANTCODE_H.Value);
                                sPlanQty = DBHelper.nvlString(drChange2["PLANQTY"]);
                                sInvoiceNo = DBHelper.nvlString(drChange2["INVOICENO"]);
                                sShipQty = DBHelper.nvlString(drChange2["SHIPQTY"]);
                                sItemCode = DBHelper.nvlString(drChange2["ITEMCODE"]);
                                sContractNo = DBHelper.nvlString(drChange2["CONTRACTNO"]);
                              ...
                              , helper.CreateParameter("AS_PCODE", "S2", DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_INVOICENO", sInvoiceNo, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_PLANQTY", sPlanQty, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_CUSTOMERCODE", sCustcode, DbType.String, ParameterDirection.Input)
                              , helper.CreateParameter("AS_USER", sUser, DbType.String, ParameterDirection.Input)
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            foreach (UltraGridRow dr in grid3.Rows)
            {
        ...
        private void DoInquire2()
        {
            ...
            try
            {
                ...
                string sSDate2 = string.Format("{0:yyyy-MM-dd}", cbo_STARTDATE2_H.Value);
                string sEDate2 = string.Format("{0:yyyy-MM-dd}", cbo_ENDDATE2_H.Value);
                string sSelOutNo = this.grid3.ActiveRow.Cells["SELOUTNO"].Value.ToString();
                ...
                string sSDate = string.Format("{0:yyyy-MM-dd}", cbo_STARTDATE_H.Value);
                string sEDate = string.Format("{0:yyyy-MM-dd}", cbo_ENDDATE_H.Value);
                string sCustCode = CModule.ToString(this.grid3.ActiveRow.Cells["CUSTCODE"].Value);

                //_GridUtil.Grid_Clear(grid1);

                //dtGrid = helper.FillTable("USP_AP0110_S2", CommandType.StoredProcedure
                //       , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_CONTRACTNO", this.grid3.ActiveRow.Cells["CONTRACTNO"].Value, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_SDATE", sSDate, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_EDATE", sEDate, DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_CLOSEFLAG", "", DbType.String, ParameterDirection.Input)
                //       , helper.CreateParameter("AS_ITEMCODE", txt_ITEMCODE_H.Text.Trim(), DbType.String, ParameterDirection.Input)
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (!bNew)
                {
                    ...
                    string sSDate = string.Format("{0:yyyy-MM-dd}", cbo_STARTDATE_H.Value);
                    string sEDate = string.Format("{0:yyyy-MM-dd}", cbo_ENDDATE_H.Value);
                    string sCustCode = CModule.ToString(this.grid1.ActiveRow.Cells["CUSTCODE"].Value);
                    string sContractNo = CModule.ToString(this.grid1.ActiveRow.Cells["CONTRACTNO"].Value);
                    string sLotNo = DBHelper.nvlString(txt_LOTNO_H.Text);

                    dtGrid = helper.FillTable("USP_WM0160_S4", CommandType.StoredProcedure
                           , helper.CreateParameter("AS_CLOSEFLAG", DbType.String, ParameterDirection.Input)
                           , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                           , helper.CreateParameter("AS_PCODE", "S3", DbType.String, ParameterDirection.Input)
                           , helper.CreateParameter("AS_CONTRACTNO", sContractNo, DbType.String, ParameterDirection.Input)
                    ...
                    dtGrid2 = helper.FillTable("USP_WM0160_S4", CommandType.StoredProcedure
                            , helper.CreateParameter("AS_CLOSEFLAG", "", DbType.String, ParameterDirection.Input)
                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                            , helper.CreateParameter("AS_PCODE", "S2", DbType.String, ParameterDirection.Input)
        ...
        //        sPlantCode = Convert.ToString(this.grid1.ActiveRow.Cells["PLANTCODE"].Value);       //공장코드
        //        sContractNo = Convert.ToString(this.grid1.ActiveRow.Cells["CONTRACTNO"].Value);     //수주번호
