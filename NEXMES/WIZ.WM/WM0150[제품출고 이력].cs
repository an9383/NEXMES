...
namespace WIZ.WM
{
    public partial class WM0150 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        private void WM0150_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                //grid3
                _GridUtil.InitializeGrid(grid3, true, false, true, "", false);
                _GridUtil.InitColumnUltraGrid(grid3, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 80, 0, Infragistics.Win.HAlign.Left, false, false);
                _GridUtil.InitColumnUltraGrid(grid3, "RESULT", "출하상태", false, GridColDataType_emu.VarChar, 120, 0, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "SHIPDATE", "출하일자", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "CUSTNAME", "수주업체", false, GridColDataType_emu.VarChar, 150, 0, Infragistics.Win.HAlign.Left, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 230, 0, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "PACKQTY", "출하수량", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Right, true, false);
            ...
            try
            {
                ...
                else
                {
                    ...
                    dtGrid = db.FillTable("USP_WM0150_S1", CommandType.StoredProcedure
                        ...
                        , db.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(cbo_PLANTCODE_H.Value), DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_SHIPNO", "", DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_CONTRACTNO", "", DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_ITEMCODE", txt_ITEMCODE_H.Text.Trim(), DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_ITEMNAME", txt_ITEMNAME_H.Text.Trim(), DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_STARTDATE", string.Format("{0:yyyy-MM-dd}", cbo_STARTDATE_H.Value), DbType.String, ParameterDirection.Input)
            ...
            try
            {
                ...
                if (bUseShipNo)
                {
                    ...
                    dtGrid = db.FillTable("USP_WM0150_S2", CommandType.StoredProcedure
                        ...
                        , db.CreateParameter("AS_CUSTCODE", DBHelper.nvlString(e.Cell.Row.Cells["CUSTCODE"].Value), DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_RESULT", DBHelper.nvlString(cbo_SHIPSTATE_H.Value), DbType.String, ParameterDirection.Input));
                }
                else
                {
                    dtGrid = db.FillTable("USP_WM0150_S2", CommandType.StoredProcedure
                        , db.CreateParameter("PCODE", "S4", DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(e.Cell.Row.Cells["PLANTCODE"].Value), DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_SHIPNO", "", DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_CONTRACTNO", "", DbType.String, ParameterDirection.Input)
                        , db.CreateParameter("AS_ITEMCODE", DBHelper.nvlString(e.Cell.Row.Cells["ITEMCODE"].Value), DbType.String, ParameterDirection.Input)
        ...
        {
            bUseShipNo = tabControl1.SelectedIndex == 1;
        ...
        {
            btnDELETE.Visible = bUseShipNo;
            btnRESTORE.Visible = bUseShipNo;
            btnCANCEL.Visible = bUseShipNo;
        }
    }
}
