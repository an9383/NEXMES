...
namespace WIZ.WM
{
    public partial class WM0145 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        private void WM0145_Load(object sender, EventArgs e)
        {
            GridInitialize();
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 150, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTQTY", "수주수량", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "SHIPQTY", "출하수량", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WMQTY", "재고수량", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PRODQTY", "재공수량", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid1, "PACKNO", "박스번호", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "DUEDATE", "마감일자", false, GridColDataType_emu.YearMonthDay, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "SHIPQTY", "출하수량", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 75, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 130, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid2, "CARNO", "차량번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "BLNO", "BL번호", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid2, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 50, 0, Infragistics.Win.HAlign.Center, false, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "SHIPNO", "출하번호", false, GridColDataType_emu.VarChar, 110, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "PACKQTY", "수량", false, GridColDataType_emu.VarChar, 50, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "PACKNO", "박스번호", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 50, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid3, "PACKDT", "포장일자", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid3, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 150, 0, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.SetInitUltraGridBind(grid3);

                //grid4
                _GridUtil.InitializeGrid(grid4, true, true, false, "", false);
                _GridUtil.InitColumnUltraGrid(grid4, "CHK", "선택", false, GridColDataType_emu.CheckBox, 20, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "PACKNO", "박스번호", false, GridColDataType_emu.VarChar, 90, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "ITEMCODE", "품목", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 100, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "PACKQTY", "포장수량", false, GridColDataType_emu.VarChar, 70, 0, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid4, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 50, 0, Infragistics.Win.HAlign.Center, true, false);
        ...
        private void grid_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            switch (grid.Name.ToUpper())
            {
                ...
                case "GRID2":
                    ...
                    txtSHIPNO.Text = grid2.ActiveRow.Cells["SHIPNO"].Text; //출하에 사용
                    PCODE = "S3";
                    CONTRACTNO = grid1.ActiveRow.Cells["CONTRACTNO"].Text;
        ...
        private void grid4_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            {
                bool chk = Convert.ToString(this.grid4.Rows[this.grid4.ActiveRow.Index].Cells["CHK"].Value).ToUpper() == "TRUE" ? true : false;

                if (chk == true)
                {
                    this.grid4.Rows[this.grid4.ActiveRow.Index].Cells["CHK"].Value = false;
                }
                else
                {
                    this.grid4.Rows[this.grid4.ActiveRow.Index].Cells["CHK"].Value = true;
                }
            }
        }
                ...
                case "I1_D1": // 폐기
                    ...
                    if (iChk > 0)
                    {
                        ...
                        if (sTag == "I1")
                        {
                            ...
                            {
                                this.ShowDialog("차량번호가 없습니다.", Forms.DialogForm.DialogType.OK);
                                return;
                            }

                            if (txtBLNO.Text.Trim() == "")
                            {
                                this.ShowDialog("BL번호가 없습니다.", Forms.DialogForm.DialogType.OK);
                                return;
                            }
                                ...
                                if (DBHelper.nvlString(grid4.Rows[i].Cells["CHK"].Value) == "1")
                                {
                                    ...
                                    if (sBoxList.Length + sBox.Length + 3 >= 4000)
                                    {
                                        helper.ExecuteNoneQuery("USP_WM0140_I3", CommandType.StoredProcedure
                                                ...
                                                , helper.CreateParameter("AS_CARNO", CARNO, DbType.String, ParameterDirection.Input)
                                                , helper.CreateParameter("AS_BLNO", BLNO, DbType.String, ParameterDirection.Input)
                                                , helper.CreateParameter("AS_CARRIERNO", CARRIERNO, DbType.String, ParameterDirection.Input)
                                                , helper.CreateParameter("AS_MAKER", UserID, DbType.String, ParameterDirection.Input));
