...
namespace WIZ.WM
{
    public partial class WM3200 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ 선언자 ]
        //그리드 객체 생성
        ...
        #region [ Form Load ]
        private void WM3200_Load(object sender, EventArgs e)
        {
            #region [ Grid1 셋팅 ]
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_WM3200_S1", CommandType.StoredProcedure
