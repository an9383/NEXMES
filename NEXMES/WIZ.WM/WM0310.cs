...
namespace WIZ.WM
{
    public partial class WM0310 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void WM0310_Load(object sender, EventArgs e)
        {
            #region ▶ GRID
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LOTQTY", "LOT수량", false, GridColDataType_emu.VarChar, 80, true, false);
            ...
            _GridUtil.SetColumnTextHAlign(grid1, "LOTQTY", Infragistics.Win.HAlign.Right);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_WM0310_S1", CommandType.StoredProcedure
