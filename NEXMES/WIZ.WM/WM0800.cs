...
namespace WIZ.WM
{
    public partial class WM0800 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void WM0800_Load(object sender, EventArgs e)
        {
            #region ▶ GRID
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 100, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "INQTY", "입고수량", false, GridColDataType_emu.VarChar, 80, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "OUTQTY", "출고수량", false, GridColDataType_emu.VarChar, 80, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                {
                    rtnDtTemp = helper.FillTable("USP_WM0700_S2", CommandType.StoredProcedure
                                                                , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                                , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                                                , helper.CreateParameter("AS_STARTDATE", sStDate, DbType.String, ParameterDirection.Input)
                                                                , helper.CreateParameter("AS_ENDDATE", sEdDate, DbType.String, ParameterDirection.Input));
