...
namespace WIZ.QM
{
    public partial class QM3110 : WIZ.Forms.BaseMDIChildForm
    {
        #region< MEMBER AREA >
        ...
        #region< FORM EVENT >
        private void QM3110_Load(object sender, EventArgs e)
        {
            #region ▶ GRID
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품명", false, GridColDataType_emu.VarChar, 180, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "MESRCODE", "측정항목", false, GridColDataType_emu.VarChar, 120, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "MESRNAME", "측정항목명", false, GridColDataType_emu.VarChar, 180, false, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_QM3110_S1"
