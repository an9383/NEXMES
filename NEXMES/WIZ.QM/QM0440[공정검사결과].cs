...
namespace WIZ.QM
{
    public partial class QM0440 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void QM0440_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        public override void DoImportExcel()
        {
            ...
            //QM0440_EXCEL QM0440_excel = new QM0440_EXCEL();
            //QM0440_excel.ShowDialog();
