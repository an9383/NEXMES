...
namespace WIZ.QM
{
    public partial class QM0051 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void QM0051_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            ...
            cbo_STARTDATE_H.Value = DateTime.Now.AddDays(-2007);
