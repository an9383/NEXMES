...
namespace WIZ.QM
{
    public partial class QM1100 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        public QM1100()
        {
            ...
            tBizManager.PopUpAdd(txtOPCode, txtOPName, "TBM0400", new object[] { cboPlantCode_H, "" });
            tBizManager.PopUpAdd(txtItemCode, txtItemName, "TBM0100", new object[] { cboPlantCode_H, "" });
            tBizManager.PopUpAdd(txtWorkCenterCode, txtWorkCenterName, "TBM0600", new object[] { cboPlantCode_H, sOPCode, sLineCode, sUseFlag });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_QM1100_S1N", CommandType.StoredProcedure
        ...
        #region 폼 로더
        private void QM1100_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
