...
namespace WIZ.QM
{
    public partial class QM1000 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        #endregion
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sWorkCenterCode = Convert.ToString(this.txtWorkCenterCode.Text.Trim());                              // 작업장 코드
                string sOPCode = this.txtOPCode.Text.Trim();                                                                // 공정 코드
                string sLineCode = "";                                                                                      // 라인 코드
                string sItemCode = this.txtItemCode.Text.Trim();                                                            // 품목

                grid1.DataSource = helper.FillTable("USP_QM1000_S1N", CommandType.StoredProcedure
        ...
        #region 폼 로더
        private void QM1000_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspDate", "검사일자", false, GridColDataType_emu.YearMonthDay, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "SeqNo", "순번", false, GridColDataType_emu.VarChar, 50, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspResultDesc", "검사내역", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        //    string sPlantCode = string.Empty;                             //사업장코드
        //    string sLineCode = string.Empty; //txtLineCode.Text.Trim();                   //라인코드
        //    string sLineName = string.Empty;//txtLineName.Text.Trim();                   //라인명명 
        //    string sUseFlag = string.Empty;                              //사용여부      
