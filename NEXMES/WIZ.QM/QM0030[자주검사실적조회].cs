...
namespace WIZ.QM
{
    public partial class QM0030 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void QM0030_Load(object sender, EventArgs e)
        {
            ...
            cbo_STARTDATE_H.Value = DateTime.Now.AddDays(-400);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_QM0030_S1", CommandType.StoredProcedure
