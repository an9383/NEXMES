...
namespace WIZ.PM
{
    public partial class PM0800 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        private void PM0800_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MONSUBNAME", "구분", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MONSUBEFFECT", "공수코드", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            ...
            string[] sMergeColumn2 = { "MONSUBNAME", "MONSUBEFFECT", "LASTAVG", "THISAVG" };
            string[] sMergeColumn3 = { "LASTAVG", "THISAVG" };
            string[] sMergeColumn4 = { "prod" };
            string[] sHeadColumn = { "prod", "MONSUBNAME", "MONSUBEFFECT", "LASTAVG", "THISAVG", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" };
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDsTemp = helper.FillDataSet("USP_PM0800_S1", CommandType.StoredProcedure, param);
                ...
                {
                    hash.Add(DBHelper.gGetCode(drRow["MONSUBEFFECT"]), drRow);
                }
                ...
                if (rtnDsTemp.Tables[0].Rows.Count > 0)
                {
                    ...
                    chart.Axis.X.Labels.Font = new System.Drawing.Font("Verdana", 7F);
                    chart.Axis.X.Labels.FontColor = System.Drawing.Color.DimGray;
                    chart.Axis.X.Labels.HorizontalAlign = System.Drawing.StringAlignment.Near;
                    chart.Axis.X.Labels.ItemFormatString = "<ITEM_LABEL>";
                    chart.Axis.X.Labels.Layout.Behavior = Infragistics.UltraChart.Shared.Styles.AxisLabelLayoutBehaviors.Auto;
                    chart.Axis.X.Labels.Orientation = Infragistics.UltraChart.Shared.Styles.TextOrientation.VerticalLeftFacing;
                    chart.Axis.X.Labels.SeriesLabels.Font = new System.Drawing.Font("Verdana", 7F);
                    chart.Axis.X.Labels.SeriesLabels.FontColor = System.Drawing.Color.DimGray;
                    chart.Axis.X.Labels.SeriesLabels.HorizontalAlign = System.Drawing.StringAlignment.Center;
                    chart.Axis.X.Labels.SeriesLabels.Layout.Behavior = Infragistics.UltraChart.Shared.Styles.AxisLabelLayoutBehaviors.Auto;
                    ...
                    chart.Axis.X2.Labels.Font = new System.Drawing.Font("Verdana", 7F);
                    chart.Axis.X2.Labels.FontColor = System.Drawing.Color.Gray;
                    chart.Axis.X2.Labels.HorizontalAlign = System.Drawing.StringAlignment.Far;
                    chart.Axis.X2.Labels.ItemFormatString = "<ITEM_LABEL>";
                    chart.Axis.X2.Labels.Layout.Behavior = Infragistics.UltraChart.Shared.Styles.AxisLabelLayoutBehaviors.Auto;
                    chart.Axis.X2.Labels.Orientation = Infragistics.UltraChart.Shared.Styles.TextOrientation.VerticalLeftFacing;
                    chart.Axis.X2.Labels.SeriesLabels.Font = new System.Drawing.Font("Verdana", 7F);
                    chart.Axis.X2.Labels.SeriesLabels.FontColor = System.Drawing.Color.Gray;
                    chart.Axis.X2.Labels.SeriesLabels.HorizontalAlign = System.Drawing.StringAlignment.Far;
                    chart.Axis.X2.Labels.SeriesLabels.Layout.Behavior = Infragistics.UltraChart.Shared.Styles.AxisLabelLayoutBehaviors.Auto;
                    chart.Axis.X2.Labels.SeriesLabels.Orientation = Infragistics.UltraChart.Shared.Styles.TextOrientation.VerticalLeftFacing;
                    chart.Axis.X2.Labels.SeriesLabels.VerticalAlign = System.Drawing.StringAlignment.Center;
                    chart.Axis.X2.Labels.VerticalAlign = System.Drawing.StringAlignment.Center;
                    chart.Axis.X2.Labels.Visible = true;
                        ...
                        for (int i = 5; i < 17; i++)
                        {
                            ...
                            if (DBHelper.gGetCode(drRow[i]) != string.Empty)
                            {
                                ...
                                try
                                {
                                    ...
                                    helper.ExecuteNoneQuery("USP_PM0800_I1", CommandType.StoredProcedure, param);
            ...
            if (grid2.Rows.Count >= 1)
            {
                ...
                if (grid2.Rows[0].Cells["M00"].Value.ToString() != string.Empty)
                {
                    ...
                    try
                    {
                        ...
                        param[0] = helper.CreateParameter("@plantcode", save_plantcode, DbType.String, ParameterDirection.Input);
                        param[1] = helper.CreateParameter("@targetclass", "CL08", DbType.String, ParameterDirection.Input);
                        param[2] = helper.CreateParameter("@Y00", save_Y00, DbType.String, ParameterDirection.Input);
                        ...
                        helper.ExecuteNoneQuery("USP_PM0800_I2", CommandType.StoredProcedure, param);
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            if (e.Cell.Column.Header.Column.ToString() != "")
            {
                ...
                try
                {
                    ...
                    param[4] = helper.CreateParameter("@targetclass", "CL08", DbType.String, ParameterDirection.Input);
                    ...
                    DataTable rtnDtTemp = helper.FillTable("USP_PM0800_S2", CommandType.StoredProcedure, param);
