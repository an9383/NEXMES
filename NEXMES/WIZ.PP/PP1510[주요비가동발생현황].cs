...
namespace WIZ.PP
{
    public partial class PP1510 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        ...
        #region PP1510_Load
        private void PP1510_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_PP1510_S1", CommandType.StoredProcedure
