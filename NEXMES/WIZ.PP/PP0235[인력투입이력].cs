...
namespace WIZ.PP
{
    public partial class PP0235 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void PP0235_Load(object sender, EventArgs e)
        {
            try
            {
                #region < GRID SETTING >
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "WORKTIME", "공정작업시간(sec)", false, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Center, true, false);
                ...
                //_GridUtil.InitColumnUltraGrid(grid3, "INITEMCODE", "투입품목", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, false, false, null, null, null, null, null);
                //_GridUtil.InitColumnUltraGrid(grid3, "INITEMNAME", "투입품명", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, false, false, null, null, null, null, null);
                //_GridUtil.InitColumnUltraGrid(grid3, "INLOTNO", "투입LOTNO", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
                //_GridUtil.InitColumnUltraGrid(grid3, "INLOTQTY", "투입수량", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, false, false, "#,###,##0", null, null, null, null);
                //_GridUtil.InitColumnUltraGrid(grid3, "INUNITCODE", "투입단위", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
                _GridUtil.InitColumnUltraGrid(grid3, "WORKERID", "투입자", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
        ...
        private void grid1_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0235_S2", CommandType.StoredProcedure
                                        , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
        ...
        private void grid2_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0235_S3", CommandType.StoredProcedure
                                             , helper.CreateParameter("AS_PlantCode", sPlantCode, DbType.String, ParameterDirection.Input)
                                             , helper.CreateParameter("AS_LOTNO", sLotNo, DbType.String, ParameterDirection.Input));
