...
namespace WIZ.PP
{
    public partial class PP0330 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        //그리드 객체 생성
        ...
        private void PP0330_Load(object sender, EventArgs e)
        {
            ...
            //_GridUtil.InitColumnUltraGrid(grid1, "AVGTOT",         "누계평균",  false, GridColDataType_emu.Double,  100, 100, Infragistics.Win.HAlign.Right,  true,  false, "###,##0.##", null, null, null, null);
            ...
            //_GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE",      "사업장",   false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            ...
            //this.cbo_STARTDATE_H.Value = System.DateTime.Today;
        ...
        public override void DoInquire()
        {
            ...
            string sStartDate = DBHelper.nvlString(cbo_STARTDATE_H.Value);
            string sEndDatee = DBHelper.nvlString(cbo_ENDDATE_H.Value);

            rtnDtTemp = helper.FillTable("USP_PP0330_S1", CommandType.StoredProcedure
                                                        ...
                                                        , helper.CreateParameter("AS_ENDDATE", sEndDatee, DbType.String, ParameterDirection.Input));

            if (rtnDtTemp.Rows.Count > 0)
            {
                spcChart1.DataSource = rtnDtTemp;
        ...
        private void DoFind1(bool check = true, int RowIndex = -1)
        {
            try
            {
                ...
                //rtnDtTemp = helper.FillTable("USP_PP0330_S2", CommandType.StoredProcedure
                //          , helper.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                //          , helper.CreateParameter("WORKCENTERCODE", sWorkcenterCode, DbType.String, ParameterDirection.Input)
