...
namespace WIZ.PP
{
    public partial class PP0217 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PP0217_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTNO", "수주번호", true, GridColDataType_emu.VarChar, 130, 90, Infragistics.Win.HAlign.Right, true, false);
            ...
            */
            ...
            try
            {
                ...
                this.grid1.DisplayLayout.Bands[0].Summaries.Add("SUM([STATUSTIME])", SummaryPosition.UseSummaryPositionColumn, this.grid1.DisplayLayout.Bands[0].Columns["STATUSTIME"]);
                this.grid1.DisplayLayout.Bands[0].Summaries[0].DisplayFormat = "{0:#,###}";
                this.grid1.DisplayLayout.Bands[0].Summaries[0].SourceColumn = this.grid1.DisplayLayout.Bands[0].Columns["STATUSTIME"];
                this.grid1.DisplayLayout.Bands[0].Summaries[0].Key = "STATUSTIME";
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0218_S1", CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_STARTDATE", sStartDate, DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ENDDATE", sEndDate, DbType.String, ParameterDirection.Input)
                                                    //, helper.CreateParameter("AS_WORKCENTERCODE", sWcCode, DbType.String, ParameterDirection.Input)
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    grid1.DataSource = UltraGridUtil.SetSubTotalUltraGrid(grid1, rtnDtTemp, "LOTNO", Common.getLangText("[ LOT별 소요시간합계 ]", "TEXT"), "LOTNO", "STATUSTIME", "SUM");
                    grid1.DataBinds();
            ...
            //    rtnDtTemp = helper.FillTable("USP_PP0217_S1", CommandType.StoredProcedure
            //                                                        , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
            //                                                        , helper.CreateParameter("AS_STARTDATE", sStartDate, DbType.String, ParameterDirection.Input)
            //                                                        , helper.CreateParameter("AS_ENDDATE", sEndDate, DbType.String, ParameterDirection.Input)
        ...
        public override void DoBaseSum()
        {
            ...
            UltraGridRow ugr = grid1.DoSummaries(new string[] { "STATUSTIME", "LOTNO", "LOTQTY", "LABELQTY", "RESULTQTY" });
