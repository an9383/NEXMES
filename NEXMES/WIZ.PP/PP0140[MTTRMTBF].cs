...
namespace WIZ.PP
{
    public partial class PP0140 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        ...
        #region < PP0140_Load >
        private void PP0140_Load(object sender, EventArgs e)
        {
            #region --- Grid Setting ---
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MT", "구분", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT01", "1월", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT02", "2월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT03", "3월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT04", "4월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT05", "5월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT06", "6월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT07", "7월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT08", "8월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT09", "9월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT10", "10월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT11", "11월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MT12", "12월", false, GridColDataType_emu.Double, 100, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "AVGTOT", "누계평균", false, GridColDataType_emu.Double, 120, 100, Infragistics.Win.HAlign.Center, true, false, "###,##0.##", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "SEQ", "SEQ", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Center, false, false, "###,##0.##", null, null, null, null);
            _GridUtil.SetInitUltraGridBind(grid1);

            _GridUtil.InitializeGrid(this.grid2, true, true, false, "", false);
            _GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid2, "WORKCENTERNAME", "작업장명", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid2, "MT", "구분", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            //_GridUtil.InitColumnUltraGrid(grid2, string.Format("{0:MMdd}", System.DateTime.Today), string.Format("{0:MM/dd}", System.DateTime.Today), false, GridColDataType_emu.VarChar, 250, 100, Infragistics.Win.HAlign.Right, true, false, "###,##0.##", null, null, null, null);
            ...
            this.cbo_STARTDATE_H.Value = System.DateTime.Today.AddDays(-30);
            this.cbo_ENDDATE_H.Value = System.DateTime.Today;
            this.txt_WORKCENTERCODE_H.Value = "WC0006";
            this.txt_WORKCENTERNAME_H.Value = "노광작업장";
            this.cbo_STARTDATE_H.Visible = false;
            this.cbo_ENDDATE_H.Visible = false;
            this.sLabel2.Visible = false;
            this.cbo_YYYY_H.Visible = true;
            fstart = Convert.ToInt32(string.Format("{0:yyyyMMdd}", this.cbo_STARTDATE_H.Value));
        }
        #endregion
        ...
        private void DoFind(bool check = true, int RowIndex = -1)
        {
            try
            {
                ...
                if (this.txt_WORKCENTERCODE_H.Text == "")
                {
                ...
                string sWorkcenterCode = this.txt_WORKCENTERCODE_H.Text.ToString();
                string sMonthDt = string.Format("{0:yyyy}", cbo_YYYY_H.Value);

                rtnDtTemp = helper.FillTable("USP_PP0140_S1", CommandType.StoredProcedure
        ...
        private void DoFind1(bool check = true, int RowIndex = -1)
        {
            try
            {
                ...
                string sPlantCode = DBHelper.nvlString(cbo_PLANTCODE_H.Value);
                string sWorkcenterCode = this.txt_WORKCENTERCODE_H.Text.ToString();
                string sSTARTDATE = string.Format("{0:yyyy-MM-dd}", this.cbo_STARTDATE_H.Value);
                string sENDDATE = string.Format("{0:yyyy-MM-dd}", this.cbo_ENDDATE_H.Value);

                grid2.DataBindings.Clear();
                rtnDtTemp = helper.FillTable("USP_PP0140_S2", CommandType.StoredProcedure
                          , helper.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("WORKCENTERCODE", sWorkcenterCode, DbType.String, ParameterDirection.Input)
        ...
        private void TabControl1_SelectedTabChanged(object sender, Infragistics.Win.UltraWinTabControl.SelectedTabChangedEventArgs e)
        {
            ...
            {
                this.cbo_STARTDATE_H.Visible = true;
                this.cbo_ENDDATE_H.Visible = true;
                this.sLabel2.Visible = true;
                this.cbo_YYYY_H.Visible = false;
                this.lbl_DATE_H.Text = "고장 일자";
        ...
        private bool CheckData(int fstart)
        {
            ...
            int sSrart = Convert.ToInt32(string.Format("{0:yyyyMMdd}", this.cbo_STARTDATE_H.Value));
            int sEnd = Convert.ToInt32(string.Format("{0:yyyyMMdd}", this.cbo_ENDDATE_H.Value));
            ...
            if (sSrart > sEnd)
            {
                ...
                this.cbo_STARTDATE_H.Value = DateTime.ParseExact(Convert.ToString(fstart), "yyyyMMdd", null);
        ...
        {
            if (Convert.ToInt32(string.Format("{0:yyyyMMdd}", this.cbo_STARTDATE_H.Value)) <= fstart)
                fstart = Convert.ToInt32(string.Format("{0:yyyyMMdd}", this.cbo_STARTDATE_H.Value));
        }
