...
namespace WIZ.PP
{
    public partial class PP0025 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        //-- return DataTable
        ...
        #region < FORM LOAD >
        private void PP0025_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MATERIAL", "재질", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, false, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sOPCode = txt_OPCODE_H.Text.Trim();                              //작업장코드    
                string sOPName = txt_OPNAME_H.Text.Trim();                              //작업장코드 
                ...
                rtnDtTemp = helper.FillTable("USP_PP0025_S1", CommandType.StoredProcedure
                                        , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
