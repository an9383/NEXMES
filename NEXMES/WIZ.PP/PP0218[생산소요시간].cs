...
namespace WIZ.PP
{
    public partial class PP0218 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PP0218_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                {
                    grid1.DataSource = UltraGridUtil.SetSubTotalUltraGrid(grid1, rtnDtTemp, "ORDERDATE", Common.getLangText("[ 작업장별 합계 ]", "TEXT"), "ORDERDATE", "ORDERQTY,PRODQTY", "SUM,SUM");
                    grid1.DataBinds();
