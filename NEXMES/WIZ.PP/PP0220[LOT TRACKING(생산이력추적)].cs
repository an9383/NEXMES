...
namespace WIZ.PP
{
    public partial class PP0220 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void PP0220_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "생산품명", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "LOTQTY", "생산수량", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Right, true, false, "#,###,##0", null, null, null, null);
                _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE", "생산단위", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INITEMNAME", "투입품명", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INLOTQTY", "투입수량", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Right, true, false, "#,###,##0", null, null, null, null);
                _GridUtil.InitColumnUltraGrid(grid1, "INUNITCODE", "투입단위", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0220_S1", CommandType.StoredProcedure
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    this.grid1.DisplayLayout.Bands[0].Columns["INUNITCODE"].MergedCellStyle = MergedCellStyle.Always;
                ...
                {
                    ClosePrgFormNew();
                    this.ShowDialog(Common.getLangText("잘못된 LOTNO입니다.", "MSG"), WIZ.Forms.DialogForm.DialogType.OK);
                }
            }
            catch (Exception ex)
            {
