...
namespace WIZ.PP
{
    public partial class PP2100 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        #endregion
        ...
        #region PP2100_Load
        private void PP2100_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorType", "불량구분", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_PP2100_S1N", CommandType.StoredProcedure
