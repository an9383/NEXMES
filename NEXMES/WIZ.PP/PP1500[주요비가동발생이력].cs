...
namespace WIZ.PP
{
    ...
    public partial class PP1500 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        ...
        public PP1500()
        {
            ...
            btbManager.PopUpAdd(txtWorkCenterCode, txtWorkCenterName, "TBM0600", new object[] { txtWorkCenterCode, txtOPCode, "", "" });
        }
        #endregion
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                */
                ...
                //param[1] = helper.CreateParameter("StartDate", sStartDate, DbType.String, ParameterDirection.Input);             // 생산시작일자    
                //param[2] = helper.CreateParameter("EndDate", sEndDate, DbType.String, ParameterDirection.Input);                 // 생산  끝일자    
                //param[3] = helper.CreateParameter("WorkCenterCode", sWorkCenterCode, DbType.String, ParameterDirection.Input);   // 작업장 코드     
                //param[4] = helper.CreateParameter("OPCode", sOPCode, DbType.String, ParameterDirection.Input);                   // 공정 코드    

                //rtnDtTemp = helper.FillTable("USP_PP1500_S1", CommandType.StoredProcedure, param);

                //grid1.DataSource = rtnDtTemp;

                grid1.DataSource = helper.FillTable("USP_PP1500_S1", CommandType.StoredProcedure
        ...
        #region 폼 로더
        private void PP1500_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "StopType", "비가동구분", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "StopClass", "비가동유형", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "StopCode", "비가동", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, true, true, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "StopDesc", "비가동명", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "STATUSTIME", "비가동시간", false, GridColDataType_emu.Integer, 100, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
        ...
        //    string sPlantCode = DBHelper.nvlString(cboPlantCode_H.SelectedValue.ToString());
        //    // string splantcd = "820";
        //    string sitemtype = "";
