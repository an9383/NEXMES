...
namespace WIZ.PP
{
    public partial class PP0250 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region  < FORM LOAD >
        private void PP0250_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMGROUP", "품목종류", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "SUBLOT", "SUBLOT", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMGROUP", "품목종류", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid3, "SUBLOT", "SUBLOT", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, true, true);
            ...
            _GridUtil.InitColumnUltraGrid(grid3, "ITEMGROUP", "품목종류", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid3, "NOWQTY", "재고량", false, GridColDataType_emu.Double, 80, 100, Infragistics.Win.HAlign.Right, true, true);
            ...
            _GridUtil.InitializeGrid(this.grid10, true, true, false, "", false);
            _GridUtil.InitColumnUltraGrid(grid10, "RUM", "SEQ", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid10, "PLANTCODE", "사업장", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid10, "IODATE", "입출고일자", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "INTYPE", "입고타입", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "OUTTYPE", "출고타입", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "STOCKQTY", "수량", false, GridColDataType_emu.Double, 80, 100, Infragistics.Win.HAlign.Right, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "FROMWHCODE", "출고창고", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "FROMLOC", "출고LOC", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "TOWHCODE", "입고창고", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "TOLOC", "입고LOC", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "REMARK", "비고", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, true);
            _GridUtil.InitColumnUltraGrid(grid10, "WORKER", "작업자", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid10, "LOTNO", "LOTNO", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid10, "SEQ", "순번", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, false, false);

            _GridUtil.SetInitUltraGridBind(grid10);
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid3, "ITEMGROUP", rtnDtTemp, "CODE_ID", "CODE_NAME");
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "FROMWHCODE", rtnDtTemp, "CODE_ID", "CODE_NAME");
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "TOWHCODE", rtnDtTemp, "CODE_ID", "CODE_NAME");
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "FROMLOC", rtnDtTemp, "CODE_ID", "CODE_NAME");
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "TOLOC", rtnDtTemp, "CODE_ID", "CODE_NAME");
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "INTYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "OUTTYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid10, "WORKER", rtnDtTemp, "CODE_ID", "CODE_NAME");
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0250_S1", CommandType.StoredProcedure
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    if (sTabIdx == "TAB2")
                    {
                        rtnDtTemp = helper.FillTable("USP_PP0250_S2", CommandType.StoredProcedure
                                                                    , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_WHCODE", sWhCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_ITEMTYPE", sItemType, DbType.String, ParameterDirection.Input)
                        ...
                        rtnDtTemp = helper.FillTable("USP_PP0250_S3", CommandType.StoredProcedure
                                                                    , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_WHCODE", sWhCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("AS_ITEMTYPE", sItemType, DbType.String, ParameterDirection.Input)
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                {
                    helper.ExecuteNoneQuery("USP_PP0250_I1"
                                          ...
                                          , helper.CreateParameter("AS_SUBLOT", DBHelper.nvlString(drRow["SUBLOT"]), DbType.String, ParameterDirection.Input)
        ...
        private void GetWhCode()
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_PP0250_S4", CommandType.StoredProcedure
        ...
        private void grid3_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            if (ultraTabControl2.SelectedTab.Index == 1)
            {
                try
                {
                    ...
                    if (rtnDtTemp.Rows.Count > 0)
                    {
                        grid10.DataSource = rtnDtTemp;
                        grid10.DataBinds(rtnDtTemp);
        ...
        private void grid10_AfterExitEditMode(object sender, EventArgs e)
        {
            if (this.grid10.Rows.Count == 0) return;

            DBHelper helper = new DBHelper("", true);

            try
            {
                string sLotNo = CModule.ToString(grid10.ActiveRow.Cells["LOTNO"].Value);              // LOTNO
                string sSEQ = CModule.ToString(grid10.ActiveRow.Cells["SEQ"].Value);
                string sRemark = CModule.ToString(grid10.ActiveRow.Cells["REMARK"].Value);
