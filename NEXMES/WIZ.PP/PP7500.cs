...
namespace WIZ.PP
{
    public partial class PP7500 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        //비지니스 로직 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sStartDate = Convert.ToString(CboStartdate_H.Value);                           // 생산시작일자
                string sEndDate = Convert.ToString(CboEnddate_H.Value);                               // 생산  끝일자
                ...
                */
                ...
                grid1.DataSource = helper.FillTable("USP_PP7500_S1", CommandType.StoredProcedure
        ...
        #region 폼 로더
        private void PP7500_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "OPName", "공장명", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ProdQty", "생산실적", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Right, true, false, "###,###,###,###", null, null, null, null);
