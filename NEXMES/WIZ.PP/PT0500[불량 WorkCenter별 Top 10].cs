...
namespace WIZ.PP
{
    public partial class PT0500 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        ...
        #region PT0500_Load
        private void PT0500_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            UltraGridUtil _GridUtil = new UltraGridUtil();
            _GridUtil.InitializeGrid(this.grid1, true, true, false, "", false);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorCode", "불량명항목", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorDesc", "불량명", false, GridColDataType_emu.Integer, 110, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorQty", "불량수량", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorCode2", "불량명항목", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorDesc2", "불량명", false, GridColDataType_emu.Integer, 110, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorQty2", "불량수량", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Center, true, false, "#,0", null, null, null, null);

            _GridUtil.SetInitUltraGridBind(grid1);

            string[] sMergeColumn = { "PlantCode1" };

            string[] sMergeColumn1 = { "ErrorCode", "ErrorDesc", "ErrorQty" };
            string[] sMergeColumn2 = { "ErrorCode2", "ErrorDesc2", "ErrorQty2" };

            string[] sHeadColumn = { "ErrorCode", "ErrorDesc", "ErrorQty", "ErrorCode2", "ErrorDesc2", "ErrorQty2" };
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sPlantCode1 = cboPlantCode_H1.Value.ToString();                                              // 사업장(공장)
                string sPlantCode2 = cboPlantCode_H2.Value.ToString();
                ...
                param[0] = helper.CreateParameter("PlantCode1", sPlantCode1, DbType.String, ParameterDirection.Input);             // 사업장(공장)    
                param[1] = helper.CreateParameter("PlantCode2", sPlantCode2, DbType.String, ParameterDirection.Input);             // 사업장(공장)    
                param[2] = helper.CreateParameter("StartDate", sStartDate, DbType.String, ParameterDirection.Input);               // 생산시작일자    
                param[3] = helper.CreateParameter("EndDate", sEndDate, DbType.String, ParameterDirection.Input);                   // 생산시작일자    


                rtnDtTemp = helper.FillTable("USP_PT0500_S1", CommandType.StoredProcedure, param);
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    series.Data.LabelColumn = "ErrorCode";
                ...
                if (rtnDtTemp.Rows.Count > 0)
                {
                    ...
                    NumericSeries series = new NumericSeries();
                    series.Data.DataSource = rtnDtTemp;
                    series.Data.LabelColumn = "ErrorCode2";
                    series.Data.ValueColumn = "ErrorQty2";
                    series.DataBind();
