...
namespace WIZ.PP
{
    public partial class PP9900 : WIZ.Forms.BaseMDIChildForm
    {
        #region [ 선언자 ]
        ...
        #region [ Form Load ]
        private void PP9900_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "DEPTCODE", "업무구분", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "DEPTNAME", "업무구분", true, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
        ...
        public override void DoDelete()
        {
            ...
            try
            {
                ...
                {
                    helper.ExecuteNoneQuery("USP_PP9900_D1"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    switch (drRow.RowState)
                    {
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_PP9900_U1"
                                                    , CommandType.StoredProcedure
        ...
        private void btnEndDate_Click(object sender, EventArgs e)
        {
            ...
            POP_MM9900 POP_PP9900 = new POP_MM9900(sPlantCode, sDeptCode);
            POP_PP9900.ShowDialog();
        }
