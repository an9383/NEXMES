...
namespace WIZ.PP
{
    public partial class PP7800 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        #endregion
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                */
                grid1.DataSource = helper.FillTable("USP_PP7800_S1", CommandType.StoredProcedure
        ...
        #region 폼 로더
        private void PP7800_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "RecDate", "일자", false, GridColDataType_emu.YearMonthDay, 90, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "UnitStopAmt", "시간당금액", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Right, true, false, "###,###,###,###", null, null, null, null);
