...
namespace WIZ.PP
{
    public partial class PP0170 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        ...
        #region < FORM LOAD >
        private void PP0170_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "OPCODE", "공정", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0170_S1", CommandType.StoredProcedure
