...
namespace WIZ.PP
{
    public partial class PP0022 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        //-- return DataTable
        ...
        #region < FORM LOAD >
        private void PP0022_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0022_S1", CommandType.StoredProcedure
