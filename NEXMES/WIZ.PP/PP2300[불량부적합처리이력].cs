...
namespace WIZ.PP
{
    public partial class PP2300 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region  PP2300_Load
        private void PP2300_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_PP2300_S1N", CommandType.StoredProcedure
