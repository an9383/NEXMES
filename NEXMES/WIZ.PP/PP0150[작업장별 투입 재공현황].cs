...
namespace WIZ.PP
{
    public partial class PP0150 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        ...
        #region < FORM LOAD >
        private void PP0150_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0150_S1", CommandType.StoredProcedure
