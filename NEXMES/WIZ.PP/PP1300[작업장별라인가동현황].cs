...
namespace WIZ.PP
{
    ...
    public partial class PP1300 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_PP1300_S2N", CommandType.StoredProcedure
        ...
        private void PP1300_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "StatusTime", "작업시간(분)", false, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "WorkerCnt", "작업자수", false, GridColDataType_emu.Integer, 80, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ProdQty", "설비카운트", false, GridColDataType_emu.Integer, 140, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ResultQty", "입고수량", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "makeType", "생성구분", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
