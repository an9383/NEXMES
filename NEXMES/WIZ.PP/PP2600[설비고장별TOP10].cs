...
namespace WIZ.PP
{
    public partial class PP2600 : WIZ.Forms.BaseMDIChildForm
    {
        #region<MEMBER AREA>
        #endregion
        ...
        #region PP2600_Load
        private void PP2600_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "OPCode", "공정", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WorkCenterName", "작업장명", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MachCode", "고장설비", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "StartDate", "고장시작시간", false, GridColDataType_emu.DateTime24, 150, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "EndDate", "종료시간", false, GridColDataType_emu.DateTime24, 150, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "FaultName", "고장명", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ArrivalTime", "작업자도착시간", false, GridColDataType_emu.DateTime24, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MAStartTime", "MA시작시간", false, GridColDataType_emu.DateTime24, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MAEndTime", "MA종료시간", false, GridColDataType_emu.DateTime24, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MADesc", "MA내역", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "Remark", "비고", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                if (grid1.Rows.Count > 0)
                {
                    ...
                    series1.Data.DataSource = grid1.DataSource;
                    series1.Data.LabelColumn = "WorkCenterName";
                    series1.Data.ValueColumn = "FAULTCODE";
                    series1.DataBind();
                    ...
                    series2.Data.DataSource = grid1.DataSource;
                    series2.Data.LabelColumn = "WorkCenterName";
                    series2.Data.ValueColumn = "FAULTTIME";
                    series2.DataBind();
