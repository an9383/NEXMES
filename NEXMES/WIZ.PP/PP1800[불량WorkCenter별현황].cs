...
namespace WIZ.PP
{
    public partial class PP1800 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMEBER AREA >
        #endregion
        ...
        #region < PP1800_Load >
        private void PP1800_Load(object sender, EventArgs e)
        {
            #region --- Grid Setting ---
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MItemCode", "모품목", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ItemName", "자품명", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "LotNo", "LotNo", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, false, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_PP1800_S1N", CommandType.StoredProcedure
