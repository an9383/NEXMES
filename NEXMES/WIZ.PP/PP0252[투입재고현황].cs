...
namespace WIZ.PP
{
    public partial class PP0252 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region  < FORM LOAD >
        private void PP0252_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0252_S1", CommandType.StoredProcedure
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                {
                    helper.ExecuteNoneQuery("USP_PP0252_I1"
