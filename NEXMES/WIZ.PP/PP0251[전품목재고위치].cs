...
namespace WIZ.PP
{
    public partial class PP0251 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region  < FORM LOAD >
        private void PP0251_Load(object sender, EventArgs e)
        {
            #region GRID SETTING
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "SAFESTOCK", "안전수량", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "MAXSTOCK", "적정수량", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, false, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_PP0251_S1", CommandType.StoredProcedure
