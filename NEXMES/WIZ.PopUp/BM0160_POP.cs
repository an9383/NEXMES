...
namespace WIZ.PopUp
{
    public partial class BM0160_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0160_POP(string[] param)
        {
            InitializeComponent();
        ...
        #region < FORM LOAD >
        private void BM0160_POP_Load(object sender, EventArgs e)
        {
        }
        #endregion
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_BM0160(sPlantCode, sInspCode, sInspName, sUseFlag);
