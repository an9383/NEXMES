...
namespace WIZ.PopUp
{
    public partial class BM0170_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0170_POP(string[] param)
        {
            InitializeComponent();
            ...
            for (int i = 0; i < param.Length; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 1:
                        txt_INSPCODE_H.Text = argument[1].ToUpper(); //검사코드
                        break;

                    case 2:
                        txt_INSPNAME_H.Text = argument[2].ToUpper(); //검사항목
                        break;
                    case 3:
        ...
        #region < FORM LOAD >
        private void BM0170_POP_Load(object sender, EventArgs e)
        {
        }
        #endregion
        ...
        private void InitGrid()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INSPCODE", "검사코드", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "INSPNAME", "검사항목", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void Search()
        {
            ...
            sInspCode = txt_INSPCODE_H.Text.Trim();
            sInspName = txt_INSPNAME_H.Text.Trim();
            sUseFlag = Convert.ToString(cbo_USEFLAG_H.Value);

            _DtTemp = _biz.SEL_BM0170(sPlantCode, sInspCode, sInspName, sUseFlag);
        ...
        private void txt_INSPCODE_H_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txt_INSPNAME_H_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                Search();
