...
namespace WIZ.PopUp
{
    public partial class AP0127_POP : WIZ.Forms.BasePopupForm
    {
        ...
        public AP0127_POP(DataRow drRow, string sPoNo)
        {
            InitializeComponent();

            //sPlantCode     = Convert.ToString(drRow["PLANTCODE"]);
            //sPoNo = Convert.ToString(drRow["PONO"]);
            sPoNo2 = Convert.ToString(drRow["PONO"]);
            ...
            txt_SHIPNO_B.Text = sPoNo2;
            //txt_POSEQ_B.Text         = sPoNo2;
            ...
            txt_PACKQTY_B.Text = sInQty;         //발주수량(A)
        ...
        #region < FORM EVENT >
        private void AP0127_POP_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                helper.ExecuteNoneQuery("USP_AP0127_D1"
                                       , CommandType.StoredProcedure
