...
namespace WIZ.PopUp
{
    public partial class TSY0030_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public TSY0030_POP(string[] param)
        {
            InitializeComponent();
            ...
            for (int i = 0; i < param.Length; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 2:
                        txt_USERID.Text = argument[2].ToUpper(); //품목
                        break;

                    case 3:
                        txt_USERNAME.Text = argument[3].ToUpper(); //품명
                        break;
        ...
        private void InitGrid()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "WORKERID", "아이디", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WORKERNAME", "이름", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void Search()
        {
            ...
            sItemCode = txt_USERID.Text.Trim();
            sItemName = txt_USERNAME.Text.Trim();
            sUseFlag = Convert.ToString(cbo_USEFLAG_H.Value);


            _DtTemp = _biz.SEL_TSY0030_N(sPlantCode, sItemCode, sItemName, sUseFlag);
