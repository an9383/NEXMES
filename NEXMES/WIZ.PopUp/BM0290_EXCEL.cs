...
namespace WIZ.PopUp
{
    public partial class BM0290_EXCEL : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        #region [ Form Load ]
        private void BM0290_EXCEL_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //GRID1
        ...
        private void INSERT_SAVE()
        {
            ...
            try
            {
                ...
                DataTable excelUpType = helper_Excel.FillTable("USP_EXCELUPLOADTYPE_S1", CommandType.StoredProcedure
                                                         , helper.CreateParameter("AS_FORMID", "BM0290", DbType.String, ParameterDirection.Input));
                ...
                if (excelUploadType == "R")
                {
                    ...
                    for (int i = 0; i < grid1.Rows.Count; i++)
                    {
                        helper.ExecuteNoneQuery("USP_BM0290_I1"
