...
namespace WIZ.PopUp
{
    public partial class POP_MM0900 : WIZ.Forms.BasePopupForm
    {
        string[] argument;
        ...
        public POP_MM0900(DataRow drRow)
        {
            InitializeComponent();
        ...
        private void POP_MM0900_Load(object sender, EventArgs e)
        {
        ...
        private void INSERT_SAVE()
        {
            ...
            try
            {
                ...
                helper.ExecuteNoneQuery("USP_MM0910Y_I1", CommandType.StoredProcedure
                                                        ...
                                                        , helper.CreateParameter("INSPIMG1", imgBuffer1, DbType.String, ParameterDirection.Input)
                                                        , helper.CreateParameter("INSPIMG2", imgBuffer2, DbType.String, ParameterDirection.Input)
                                                        , helper.CreateParameter("INSPIMG3", imgBuffer3, DbType.String, ParameterDirection.Input)
                                                        , helper.CreateParameter("INSPIMG4", imgBuffer4, DbType.String, ParameterDirection.Input)
        ...
        private void DELETEIMG(System.Windows.Forms.Button a)
        {
            ...
            try
            {
                ...
                if (result.ToString().ToUpper() == "YES")
                {
                    if (del_lot == "XBOX")
                    {
                        MessageBox.Show("기본 이미지는 삭제 할 수 없습니다.");
                        return;
                    }
                    else
                    {
