...
namespace WIZ.PopUp
{
    public partial class WM0050_POP1 : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        WM0060_POP_TEL WM0060_POP_TEL; //원자재 식별표
        DataRow dRow;
        ...
        public WM0050_POP1(DataRow drRow)
        {
            InitializeComponent();
        ...
        #region [ FORM LOAD ]
        private void WM0050_POP1_Load(object sender, EventArgs e)
        {
            //그리드 객체 생성
        ...
        private void SendPrint(string sPlantCode, string sLotno)
        {
            ...
            try
            {
                DataTable rtnDtTemp = helper.FillTable("USP_WM0050_POP1_S1"
                ...
                if (helper.RSCODE == "S")
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < rtnDtTemp.Rows.Count; i++)
                        {
                            ...
                            dRow["INDATE" + Convert.ToString(_columnCnt + 1)] = rtnDtTemp.Rows[0]["INDATE"];
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    helper.ExecuteNoneQuery("USP_WM0050_POP1_U1", CommandType.StoredProcedure
                                                                , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                ...
                helper.ExecuteNoneQuery("USP_WM0050_POP1_U2", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_LOTNO", DBHelper.nvlString(this.txt_LOTNO_H.Text), DbType.String, ParameterDirection.Input)
