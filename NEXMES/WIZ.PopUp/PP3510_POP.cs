...
namespace WIZ.PopUp
{
    public partial class PP3510_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public PP3510_POP(string[] param)
        {
            InitializeComponent();
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_PP3510(sPlantCode, sItemCode, sItemName, sItemType, sUseFlag, sSpec);
