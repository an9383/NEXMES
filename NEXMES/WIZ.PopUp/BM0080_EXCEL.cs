...
namespace WIZ.PopUp
{
    public partial class BM0080_EXCEL : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        #region [ Form Load ]
        private void BM0080_EXCEL_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WHNAME", "창고명", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "WHTYPE", "창고유형", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "BASEWHFLAG", "기본창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "PRODWHFLAG", "생산창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "METWHFLAG", "자재창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "DEPTCODE", "부서", true, GridColDataType_emu.VarChar, 150, 130, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "업체", true, GridColDataType_emu.VarChar, 130, 130, Infragistics.Win.HAlign.Left, true, false);
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("WHCODE"); //창고유형
            ...
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "BASEWHFLAG", rtnDtTemp, "CODE_ID", "CODE_NAME");
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "PRODWHFLAG", rtnDtTemp, "CODE_ID", "CODE_NAME");
            WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "METWHFLAG", rtnDtTemp, "CODE_ID", "CODE_NAME");
        ...
        private void INSERT_SAVE()
        {
            ...
            string WHTYPE = string.Empty;
            string BASEWHFLAG = string.Empty;
            string PRODWHFLAG = string.Empty;
            string METWHFLAG = string.Empty;
            ...
            try
            {
                for (int i = 0; i < grid1.Rows.Count; i++)
                {
                    ...
                    WHNAME = Convert.ToString(grid1.Rows[i].Cells["WHNAME"].Value);
                    WHTYPE = Convert.ToString(grid1.Rows[i].Cells["WHTYPE"].Value);
                    BASEWHFLAG = Convert.ToString(grid1.Rows[i].Cells["BASEWHFLAG"].Value);
                    PRODWHFLAG = Convert.ToString(grid1.Rows[i].Cells["PRODWHFLAG"].Value);
                    METWHFLAG = Convert.ToString(grid1.Rows[i].Cells["METWHFLAG"].Value);
                    DEPTCODE = Convert.ToString(grid1.Rows[i].Cells["DEPTCODE"].Value);
                ...
                DataTable excelUpType = helper_Excel.FillTable("USP_EXCELUPLOADTYPE_S1", CommandType.StoredProcedure
                                                         , helper.CreateParameter("AS_FORMID", "BM0080", DbType.String, ParameterDirection.Input));
                ...
                if (excelUploadType == "R")
                {
                    ...
                    for (int i = 0; i < grid1.Rows.Count; i++)
                    {
                        helper.ExecuteNoneQuery("USP_BM0080_EXCEL_I1", CommandType.StoredProcedure
                                               ...
                                               , helper.CreateParameter("AS_WHNAME", Convert.ToString(grid1.Rows[i].Cells["WHNAME"].Value), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_WHTYPE", Convert.ToString(grid1.Rows[i].Cells["WHTYPE"].Value), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_BASEWHFLAG", Convert.ToString(grid1.Rows[i].Cells["BASEWHFLAG"].Value), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_PRODWHFLAG", Convert.ToString(grid1.Rows[i].Cells["PRODWHFLAG"].Value), DbType.String, ParameterDirection.Input)
                                               , helper.CreateParameter("AS_METWHFLAG", Convert.ToString(grid1.Rows[i].Cells["METWHFLAG"].Value), DbType.String, ParameterDirection.Input)
            ...
            try
            {
                ...
                if (openfiledialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    for (int i = 1; i < dtExcelImport.Rows.Count; i++)
                    {
                        ...
                        drTarget["WHNAME"] = Convert.ToString(dtExcelImport.Rows[i][1]);
                        drTarget["WHTYPE"] = Convert.ToString(dtExcelImport.Rows[i][2]);
                        drTarget["BASEWHFLAG"] = Convert.ToString(dtExcelImport.Rows[i][3]);
                        drTarget["PRODWHFLAG"] = Convert.ToString(dtExcelImport.Rows[i][4]);
                        drTarget["METWHFLAG"] = Convert.ToString(dtExcelImport.Rows[i][5]);
                        drTarget["DEPTCODE"] = Convert.ToString(dtExcelImport.Rows[i][6]);
                        drTarget["CUSTCODE"] = Convert.ToString(dtExcelImport.Rows[i][7]);
                        drTarget["USEFLAG"] = Convert.ToString(dtExcelImport.Rows[i][8]).Trim();
                        drTarget["REMARK"] = Convert.ToString(dtExcelImport.Rows[i][9]);
