...
namespace WIZ.PopUp
{
    public partial class BM0430_EXCEL : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        #region [ Form Load ]
        private void BM0430_EXCEL_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            //검사항목
            gridManager.PopUpAdd("INSPCODE", "INSPNAME", "BM0190", new string[] { "PLANTCODE", "Y" });
            #endregion
        }
        #endregion
        ...
        private void INSERT_SAVE()
        {
            ...
            try
            {
                ...
                DataTable excelUpType = helper_Excel.FillTable("USP_EXCELUPLOADTYPE_S1", CommandType.StoredProcedure
                                                         , helper.CreateParameter("AS_FORMID", "BM0430", DbType.String, ParameterDirection.Input));
