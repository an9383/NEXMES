...
namespace WIZ.PopUp
{
    public partial class BM0150_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0150_POP(string[] param)
        {
            InitializeComponent();
        ...
        #region < FORM LOAD >
        private void BM0150_POP_Load(object sender, EventArgs e)
        {
        }
        #endregion
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_BM0150(sPlantCode, sInspCode, sInspName, sUseFlag);
