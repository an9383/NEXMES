...
namespace WIZ.PopUp
{
    public partial class BM0010_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0010_POP(string[] param)
        {
            InitializeComponent();
        ...
        private void InitGrid()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ITEMTYPE", "품목유형", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "UNITCODE", "단위", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_BM0010(sPlantCode, sItemCode, sItemName, sItemType, sUseFlag, sSpec);
