...
namespace WIZ.PopUp
{
    public partial class MM0070_POP2 : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        MM0070_POP2_TEL MM0070_POP2_TEL;
        #endregion

        #region [ 생성자 ]

        public MM0070_POP2(string PlantCode, WIZ.Control.Grid Grid1)
        {
            InitializeComponent();
        ...
        #region [ Form Load ]
        private void MM0070_POP2_Load(object sender, EventArgs e)
        {
            //그리드 객체 생성
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "거래처코드", false, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "CUSTNAME", "거래처명", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "NOWQTY", "수량", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LOTSTATUS", "LOT상태", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid1, "PONO", "발주번호", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "POSEQNO", "발주순번", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Center, false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ROWSEQ", "ROWSEQ", false, GridColDataType_emu.VarChar, 60, 100, Infragistics.Win.HAlign.Left, false, false);
            ...
            txt_PLANTCODE_H.Value = DtChange1.Rows[0]["PLANTCODE"].ToString();
            txt_WCCODE_H.Text = DtChange1.Rows[0]["WHCODE"].ToString();
            txt_STORAGELOCCODE_H.Text = DtChange1.Rows[0]["STORAGELOCCODE"].ToString();
            txt_ITEMCODE_H.Text = DtChange1.Rows[0]["ITEMCODE"].ToString();
            txt_ITEMNAME_H.Text = DtChange1.Rows[0]["ITEMNAME"].ToString();
        ...
        private void SendPrint(string sPlantCode, string sLotno)
        {
            ...
            try
            {
                DataTable rtnDtTemp = helper.FillTable("USP_MM0070_POP2_S1"
                ...
                if (helper.RSCODE == "S")
                {
                    ...
                    else
                    {
                        //텔레릭 레포트로 출력시
                        //rtnDtTemp 데이터바인딩
                        MM0070_POP2_TEL = new MM0070_POP2_TEL();
                        objectDataSource.DataSource = rtnDtTemp;
                        MM0070_POP2_TEL.DataSource = objectDataSource;
                        viewerInstance.ReportDocument = MM0070_POP2_TEL.Report;
                        ...
                        //뷰어 없이 바로 출력
                        Telerik.Reporting.IReportDocument myReport = new MM0070_POP2_TEL();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < this.grid1.Rows.Count; i++)
                {
                    ...
                    // 병합 대상 출고
                    helper.ExecuteNoneQuery("USP_MM0070_POP2_I1", CommandType.StoredProcedure
                                                                , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                                , helper.CreateParameter("AS_LOTNO", sLotNo, DbType.String, ParameterDirection.Input)
                ...
                helper.ExecuteNoneQuery("USP_MM0070_POP2_I2", CommandType.StoredProcedure
                                                       , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                ...
                if (helper.RSCODE == "S")
                {
                    ...
                    MessageBox.Show(Common.getLangText("LOT 병합을 완료하였습니다.", "MSG"), Common.getLangText("LOT 병합 성공", "MSG"));
                    helper.Commit();
        ...
        private void GetWHCODE()
        {
            ...
            try
            {
                ...
                command.AppendLine(" WHERE PLANTCODE = '" + txt_PLANTCODE_H.Value.ToString() + "' ");
                command.AppendLine("   AND WHTYPE  = 'WH001'");
