...
namespace WIZ.PopUp
{
    public partial class BM0190_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0190_POP(string[] param)
        {
            InitializeComponent();
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_BM0190(sPlantCode, sInspCode, sInspName, sUseFlag);
