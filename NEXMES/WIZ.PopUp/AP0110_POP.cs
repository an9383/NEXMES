...
namespace WIZ.PopUp
{
    public partial class AP0110_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public AP0110_POP(string[] param)
        {
            InitializeComponent();
            ...
            for (int i = 0; i < param.Length; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 5:
                        txt_CONTRACTNAME_H.Text = argument[5].ToUpper(); //거래처명
                        break;
                    case 6:
                        //품목은 디자인에서 숨김처리 함
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        txt_CONTRACTNAME_H.Text = argument[8].ToUpper() == "" ? "ALL" : argument[8].ToUpper(); //사용여부
                        break;
                }
                #endregion
            }
        ...
        private void InitGrid()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTNO", "수주번호", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "CONTRACTNAME", "수주이름", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void Search()
        {
            ...
            string sContractName = string.Empty;
            string sItemCode = string.Empty;
            string sSdate = string.Empty;
            string sEdate = string.Empty;
            sPlantCode = Convert.ToString(cbo_PLANTCODE_H.Value);

            sContractno = txt_CONTRACTNO_H.Text.Trim();
            sContractName = txt_CONTRACTNAME_H.Text.Trim();
            sItemCode = txt_ITEMCODE_H.Text.Trim();
            sCustCode = txt_CUSTCODE_H.Text.Trim();
            sUseFlag = Convert.ToString(cbo_USEFLAG_H.Value);
            //_DtTemp = _biz.SEL_AP0110(sPlantCode, sContractno, sCustCode, sCustName, sItemCode, sUseFlag);
            _DtTemp = _biz.SEL_AP0110(sPlantCode, sContractno, sContractName, sItemCode, sCustCode);
        ...
        private void grid1_DoubleClickRow(object sender, Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs e)
        {
            ...
            TmpDt.Columns.Add("CONTRACTNO", typeof(string));
            //TmpDt.Columns.Add("CONTRACTNAME", typeof(string));

            TmpDt.Rows.Add(new object[] { e.Row.Cells["CONTRACTNO"].Value });
