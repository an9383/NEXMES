...
namespace WIZ.PopUp
{
    public partial class BM0320_EXCEL : WIZ.Forms.BasePopupForm
    {
        #region [ 선언자 ]
        ...
        #region [ Form Load ]
        private void BM0320_EXCEL_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            //GRID1
        ...
        private void INSERT_SAVE()
        {
            ...
            try
            {
                ...
                DataTable excelUpType = helper_Excel.FillTable("USP_EXCELUPLOADTYPE_S1", CommandType.StoredProcedure
                                                         , helper.CreateParameter("AS_FORMID", "BM0320", DbType.String, ParameterDirection.Input));
