...
namespace WIZ.PopUp
{
    public partial class MM0000_POP2 : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public MM0000_POP2(DataRow drRow, bool bCheckPackQty = false, string sDate = "")
        {
            InitializeComponent();
        ...
        #region < FORM EVENT >
        private void MM0000_POP2_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
