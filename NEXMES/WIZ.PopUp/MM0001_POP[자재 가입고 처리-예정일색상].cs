...
namespace WIZ.PopUp
{
    public partial class MM0001_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public MM0001_POP(DataRow drRow)
        {
            InitializeComponent();
        ...
        #region < FORM EVENT >
        private void MM0001_POP_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
        ...
        private void SendPrint(string sPlantCode, string sPoNo, string sTmpInGroupNo)
        {
            ...
            try
            {
                DataTable rtnDtTemp = helper.FillTable("USP_MM0000_POP_S1", CommandType.StoredProcedure
                                                  , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                  , helper.CreateParameter("AS_PONO", sPoNo, DbType.String, ParameterDirection.Input)
