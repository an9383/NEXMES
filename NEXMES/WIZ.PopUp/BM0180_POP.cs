...
namespace WIZ.PopUp
{
    public partial class BM0180_POP : WIZ.Forms.BasePopupForm
    {
        #region < MEMBER AREA >
        ...
        public BM0180_POP(string[] param)
        {
            InitializeComponent();
        ...
        private void Search()
        {
            ...
            _DtTemp = _biz.SEL_BM0180(sPlantCode, sInspCode, sInspName, sUseFlag);
