...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM0660
//   Form Name    : 일자별 작업장근무형태 관리
//   Name Space   : WIZ.BM
//   Created Date : 2018-01-09
//   Made By      : WIZCORE 남부사무소 사원 윤근욱
//   Edited Date  : 
//   Edit By      :
//   Description  : 일자별 작업장근무형태를 관리
// *---------------------------------------------------------------------------------------------*                                                                                                   
#endregion
...
namespace WIZ.BM
{
    public partial class BM0660 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0660_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LINECODE", "라인", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "WORKCENTERCODE", "작업장코드", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "DWRKTYPECODE", "주간근무형태코드", true, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Center, true, true);
            ...
            bizGridManager.PopUpAdd("WORKCENTERCODE", "WORKCENTERNAME", "BM0060", new string[] { "PLANTCODE", "", "LINECODE", "Y" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0660_S1", CommandType.StoredProcedure
            ...
            try
            {
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    if (drRow.RowState != DataRowState.Deleted)
                    {
                        ...
                        if (Convert.ToString(drRow["WORKCENTERNAME"]) == string.Empty)
                        {
                            this.ClosePrgFormNew();
                            this.ShowDialog(Common.getLangText("작업장명은 필수 입력항목입니다..", "MSG"), Forms.DialogForm.DialogType.OK);
                            return;
                        }
                        #endregion
                    }
                    ...
                    #region 추가                            
                    helper.ExecuteNoneQuery("USP_BM0660_I1", CommandType.StoredProcedure
        ...
        private void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txt_WORKCENTERCODE_H.Text.Trim().ToString() == "")
                {
                    this.ShowDialog(Common.getLangText("작업장 정보를 선택하세요", "MSG"), WIZ.Forms.DialogForm.DialogType.OK);
                    return;
                }
                ...
                rtnDtTemp = helper.FillTable("USP_BM0660_S2", CommandType.StoredProcedure
