...
namespace WIZ.BM
{
    ...
    public partial class BM2600 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region BM2600_Load
        private void BM2600_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WorkCenterCode", "작업장코드", true, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorCode", "불량코드", true, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM2600_S1N", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                UltraGridUtil.ActivationAllowEdit(this.grid1, "WorkCenterName");    // 작업장명명
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2600_D1N", CommandType.StoredProcedure
                                                    ...
                                                    , helper.CreateParameter("ErrorCode", Convert.ToString(drRow["ErrorCode"]), DbType.String, ParameterDirection.Input));           // 불량사유
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2600_I1N", CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)            // 공장(사업장)
                                                    , helper.CreateParameter("WorkCenterCode", Convert.ToString(drRow["WorkCenterCode"]), DbType.String, ParameterDirection.Input)  // 작업장코드
                                                    , helper.CreateParameter("ErrorCode", Convert.ToString(drRow["ErrorCode"]), DbType.String, ParameterDirection.Input)            // 불량사유
                                                    , helper.CreateParameter("DisplayNo", Convert.ToString(drRow["DisplayNo"]), DbType.String, ParameterDirection.Input)            // Display No
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2600_U1N", CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)          // 공장(사업장)
                                                    , helper.CreateParameter("WorkCenterCode", Convert.ToString(drRow["WorkCenterCode"]), DbType.String, ParameterDirection.Input)  // 작업장코드
                                                    , helper.CreateParameter("ErrorCode", Convert.ToString(drRow["ErrorCode"]), DbType.String, ParameterDirection.Input)            // 불량사유
                                                    , helper.CreateParameter("DisplayNo", Convert.ToString(drRow["DisplayNo"]), DbType.String, ParameterDirection.Input)            // Display No
