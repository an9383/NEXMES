...
namespace WIZ.BM
{
    public partial class BM5110 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM5110_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "PlantCode", "사업장", true, GridColDataType_emu.VarChar, 200, 200, Infragistics.Win.HAlign.Left, false, false);
                _GridUtil.InitColumnUltraGrid(grid1, "AlarmCode", "알람코드", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "AlarmText", "알람내용", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, false, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WorkerID", "작업자ID", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WorkerName", "작업자명", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "MAILID", "메일", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "PHONENO", "PHONE 번호", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "ActionYN", "처리사용자여부", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "ActionLevel", "처리레벨", true, GridColDataType_emu.Integer, 140, 130, Infragistics.Win.HAlign.Center, true, false);
                ...
                rtnDtTemp = _Common.GET_BM0000_CODE("USEFLAG"); //처리사용자여부
                WIZ.Common.FillComboboxMaster(this.cbo_USEFLAG_H, rtnDtTemp, rtnDtTemp.Columns["CODE_ID"].ColumnName, rtnDtTemp.Columns["CODE_NAME"].ColumnName, "ALL", "");
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "ActionYN", rtnDtTemp, "CODE_ID", "CODE_NAME");
                ...
                //알람
                btbManager.PopUpAdd(txt_ITEMCODE_H, txt_ITEMNAME_H, "BM5100", new object[] { "", "", cbo_USEFLAG_H });
                ...
                gridManager.PopUpAdd("AlarmCode", "AlarmText", "BM5100", new string[] { "PLANTCODE", "", "Y" });
                gridManager.PopUpAdd("WorkerID", "WorkerName", "TSY0030", new string[] { "PLANTCODE", "", "Y" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM5110_S1", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                this.grid1.ActiveRow.Cells["ActionYN"].Value = "Y";
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM5110_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    ...
                                                    , helper.CreateParameter("AS_ACTIONYN", DBHelper.nvlString(drRow["ActionYN"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ACTIONLEVEL", DBHelper.nvlString(drRow["ActionLevel"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            //BM5110_EXCEL BM5110_excel = new BM5110_EXCEL();
            //BM5110_excel.ShowDialog();
