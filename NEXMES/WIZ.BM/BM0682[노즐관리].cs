...
namespace WIZ.BM
{
    public partial class BM0682 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        private void BM0682_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LIFETIME", "수명(일)", true, GridColDataType_emu.VarChar, 60, 100, Infragistics.Win.HAlign.Right, true, true);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMCODE", "품목", true, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Left, true, true);
            _GridUtil.InitColumnUltraGrid(grid2, "ITEMNAME", "품명", true, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, true);
            _GridUtil.InitColumnUltraGrid(grid2, "MAXCOUNT", "최대 사용량", true, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Right, true, true);
            _GridUtil.InitColumnUltraGrid(grid2, "INCOUNT", "연속 사용량", true, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Right, true, true);
            _GridUtil.InitColumnUltraGrid(grid2, "WORKLIMITTIME", "연속 작업시간", true, GridColDataType_emu.VarChar, 110, 100, Infragistics.Win.HAlign.Right, true, true);
            _GridUtil.InitColumnUltraGrid(grid2, "UNITCODE", "단위", true, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, true, true);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0682_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0682_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE",    DBHelper.nvlString(drRow["PLANTCODE"]),    DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0682_U1"
                                                     , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE",   DBHelper.nvlString(drRow["PLANTCODE"]),   DbType.String, ParameterDirection.Input)
