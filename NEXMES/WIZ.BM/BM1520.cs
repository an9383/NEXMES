...
namespace WIZ.BM
{
    public partial class BM1520 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        private void BM1520_Load(object sender, EventArgs e)
        {
            #region Grid1 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspType", "검사대상", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "UnitType", "단위종류", false, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("INSPCASE", " MinorCode ='QC'");     // 검사구분            
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM1520_S2"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1520_D2"
                                                    , CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1520_I2"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1520_U2"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("InspName", Convert.ToString(drRow["InspName"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("InspDesc", Convert.ToString(drRow["InspDesc"]), DbType.String, ParameterDirection.Input)
