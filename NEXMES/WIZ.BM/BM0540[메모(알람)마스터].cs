...
namespace WIZ.BM
{
    public partial class BM0540 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0540_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "MEMOID", "메모ID", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "MEMOTITLE", "메모 제목", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "MEMODESC", "메모 내용", true, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "ALLARMFLAG", "전체게시여부", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "OPCODE", "적용공정", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "LINECODE", "적용라인", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "WORKCENTERCODE", "적용작업장", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "WORKCENTERNAME", "적용작업장명", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "STARTDATE", "게시 시작일자", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "ENDDATE", "게시 종료일자", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Center, true, true);
                ...
                grid1.DisplayLayout.Bands[0].Columns["MEMOID"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "ALLARMFLAG", rtnDtTemp, "CODE_ID", "CODE_NAME");
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sMemoId = DBHelper.nvlString(txt_MEMOID_H.Text.Trim());
                ...
                rtnDtTemp = helper.FillTable("USP_BM0540_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_MEMOID", sMemoId, DbType.String, ParameterDirection.Input)
        ...
        public override void DoNew()
        {
            try
            {
                ...
                this.grid1.ActiveRow.Cells["MEMOID"].Value = Common.getLangText("자동채번", "TEXT");

                //사용자 입력이 필요하지 않은 부분은 행 추가시 수정이 안되도록 조치
                grid1.ActiveRow.Cells["MEMOID"].Activation = Activation.NoEdit;
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0540_I1"
                                                    ...
                                                    , helper.CreateParameter("AS_MEMOTITLE", DBHelper.nvlString(drRow["MEMOTITLE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_MEMODESC", DBHelper.nvlString(drRow["MEMODESC"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ALLARMFLAG", DBHelper.nvlString(drRow["ALLARMFLAG"]), DbType.String, ParameterDirection.Input)
                                                    ...
                                                    , helper.CreateParameter("AS_STARTDATE", DBHelper.nvlString(drRow["STARTDATE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ENDDATE", DBHelper.nvlString(drRow["ENDDATE"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0540_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_MEMOID", DBHelper.nvlString(drRow["MEMOID"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_MEMOTITLE", DBHelper.nvlString(drRow["MEMOTITLE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_MEMODESC", DBHelper.nvlString(drRow["MEMODESC"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ALLARMFLAG", DBHelper.nvlString(drRow["ALLARMFLAG"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_OPCODE", DBHelper.nvlString(drRow["OPCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0540_EXCEL bm0540_excel = new BM0540_EXCEL();
            bm0540_excel.ShowDialog();
