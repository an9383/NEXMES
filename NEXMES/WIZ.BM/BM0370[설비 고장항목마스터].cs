...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM0370
//   Form Name    : 설비 고장항목마스터
//   Name Space   : WIZ.BM
//   Created Date : 2018-01-08
//   Made By      : WIZCORE 남부사무소 사원 최수정
//   Edited Date  : 
//   Edit By      :
//   Description  : 설비고장항목 관리
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0370 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0370_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "FAILURENAME", "고장명", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "FAILURETYPE", "고장분류", true, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, true);
                ...
                grid1.DisplayLayout.Bands[0].Columns["FAILURENAME"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                rtnDtTemp = _Common.GET_BM0000_CODE("FAILURETYPE"); //고장 구분
                ...
                //고장코드
                btbManager.PopUpAdd(txt_FAILURECODE_H, txt_FAILURENAME_H, "BM0370", new object[] { cbo_FAILURETYPE_H, "", cbo_USEFLAG_H });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sFailUreName = DBHelper.nvlString(txt_FAILURENAME_H.Text.Trim());
                string sFailUreType = DBHelper.nvlString(cbo_FAILURETYPE_H.Value);
                string sUseFlag = DBHelper.nvlString(cbo_USEFLAG_H.Value);

                rtnDtTemp = helper.FillTable("USP_BM0370_S1", CommandType.StoredProcedure
            ...
            try
            {
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    if (drRow.RowState != DataRowState.Deleted)
                    {
                        ...
                        {
                            this.ClosePrgFormNew();
                            this.ShowDialog(Common.getLangText("고장 분류는 필수 입력항목입니다..", "MSG"), Forms.DialogForm.DialogType.OK);
                            return;
                        }
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0370_I1"
                                                    ...
                                                    , helper.CreateParameter("AS_FAILURENAME", DBHelper.nvlString(drRow["FAILURENAME"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0370_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0370_EXCEL bm0370_excel = new BM0370_EXCEL();
            bm0370_excel.ShowDialog();
