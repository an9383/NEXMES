...
namespace WIZ.BM
{
    public partial class BM0460 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0460_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                //점검항목
                btbManager.PopUpAdd(txt_MACHKCODE_H, txt_MACHKNAME_H, "BM0460", new object[] { cbo_PLANTCODE_H, "" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0460_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0460_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0460_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
