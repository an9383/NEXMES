...
namespace WIZ.BM
{
    public partial class BM0050 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0050_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "LINENAME", "라인명", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true);
                ...
                //라인
                btbManager.PopUpAdd(txt_LINECODE_H, txt_LINENAME_H, "BM0050", new object[] { cbo_PLANTCODE_H, bte_OPCODE_H, cbo_USEFLAG_H });

                //공정
                btbManager.PopUpAdd(bte_OPCODE_H, txt_OPNAME_H, "BM0040", new object[] { cbo_PLANTCODE_H, cbo_OPTYPE_H, cbo_USEFLAG_H });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sOpCode = DBHelper.nvlString(bte_OPCODE_H.Text.Trim());
                ...
                rtnDtTemp = helper.FillTable("USP_BM0050_S1", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                this.grid1.ActiveRow.Cells["LINECODE"].Value = Common.getLangText("자동채번", "TEXT");

                //사용자 입력이 필요하지 않은 부분은 행 추가시 수정이 안되도록 조치
                grid1.ActiveRow.Cells["OPTYPE"].Activation = Activation.NoEdit;
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0050_I1"
                                                    ...
                                                    , helper.CreateParameter("AS_LINENAME", DBHelper.nvlString(drRow["LINENAME"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0050_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_OPCODE", DBHelper.nvlString(drRow["OPCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0050_EXCEL bm0050_excel = new BM0050_EXCEL();
            bm0050_excel.ShowDialog();
