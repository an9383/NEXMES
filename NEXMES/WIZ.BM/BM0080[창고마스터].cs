...
//   Edited Date  : 
//   Edit By      :
//   Description  : 자재, 제품, 반제품등 모든 창고 정보 관리
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0080 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0080_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "PLANTCODE", "사업장", true, GridColDataType_emu.VarChar, 140, 130, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "WHCODE", "창고코드", true, GridColDataType_emu.VarChar, 90, 90, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "WHNAME", "창고명", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "WHTYPE", "창고유형", true, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "BASEWHFLAG", "기본창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, false, true);
                _GridUtil.InitColumnUltraGrid(grid1, "PRODWHFLAG", "생산창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, false, true);
                _GridUtil.InitColumnUltraGrid(grid1, "METWHFLAG", "자재창고", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Left, false, true);
                _GridUtil.InitColumnUltraGrid(grid1, "DEPTCODE", "부서", true, GridColDataType_emu.VarChar, 150, 130, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "업체", true, GridColDataType_emu.VarChar, 90, 130, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTNAME", "업체명", true, GridColDataType_emu.VarChar, 150, 130, Infragistics.Win.HAlign.Left, true, true);
                ...
                gridManager.PopUpAdd("CUSTCODE", "CUSTNAME", "BM0030", new string[] { "PLANTCODE", "", "Y" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sWhType = DBHelper.nvlString(cbo_WHTYPE_H.Value);
                string sUseFlag = DBHelper.nvlString(cbo_USEFLAG_H.Value);

                rtnDtTemp = helper.FillTable("USP_BM0080_S1", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                this.grid1.ActiveRow.Cells["WHCODE"].Value = Common.getLangText("자동채번", "TEXT");
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0080_I1"
                                                    ...
                                                    , helper.CreateParameter("AS_WHNAME", DBHelper.nvlString(drRow["WHNAME"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_WHTYPE", DBHelper.nvlString(drRow["WHTYPE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_BASEWHFLAG", DBHelper.nvlString(drRow["BASEWHFLAG"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_PRODWHFLAG", DBHelper.nvlString(drRow["PRODWHFLAG"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_METWHFLAG", DBHelper.nvlString(drRow["METWHFLAG"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0080_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_WHCODE", DBHelper.nvlString(drRow["WHCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_WHNAME", DBHelper.nvlString(drRow["WHNAME"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0080_EXCEL bm0080_excel = new BM0080_EXCEL();
            bm0080_excel.ShowDialog();
