...
namespace WIZ.BM
{
    public partial class BM1530 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        private void BM1530_Load(object sender, EventArgs e)
        {
            #region Grid1 셋팅
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("INSPCASE", " MinorCode ='DA'");     // 검사구분            
            ...
            //rtnDtTemp = _Common.GET_TBM0000_CODE("INSPCASE");     // 검사구분            
            //WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "InspCase", rtnDtTemp, "CODE_ID", "CODE_NAME");
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM1530_S2"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1530_D2"
                                                    , CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1530_I2"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1530_U2"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("InspName", Convert.ToString(drRow["InspName"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("InspDesc", Convert.ToString(drRow["InspDesc"]), DbType.String, ParameterDirection.Input)
