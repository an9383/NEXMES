...
//   Made By      : WIZCORE                                                                                                                                      
//   Description  : 라인별로 발생가능 불량한 정보를 관리 한다                                                                                                                                                           
// *---------------------------------------------------------------------------------------------*                                                                                                  
#endregion
...
namespace WIZ.BM
{
    ...
    public partial class BM2700 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        public BM2700()
        {
            ...
            // grid pop-up 처리를 위한 정의 (LineCode(작업장 TBM0400),불량유형
        ...
        #region BM2700_Load
        private void BM2700_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM2700_S1N"
        ...
        public override void DoNew()
        {
            try
            {
                ...
                UltraGridUtil.ActivationAllowEdit(this.grid1, "LineName");          // 라인명명
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2700_D1N"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)           // 공장(사업장)
                                                    , helper.CreateParameter("LineCode", drRow["LineCode"].ToString(), DbType.String, ParameterDirection.Input)             // 라인코드
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2700_I1N"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)            // 공장(사업장)
                                                   , helper.CreateParameter("LineCode", drRow["LineCode"].ToString(), DbType.String, ParameterDirection.Input)              // 라인코드
                                                   , helper.CreateParameter("ErrorCode", drRow["ErrorCode"].ToString(), DbType.String, ParameterDirection.Input)            // 불량사유
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2700_U1N"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)            // 공장(사업장)
                                                   , helper.CreateParameter("LineCode", drRow["LineCode"].ToString(), DbType.String, ParameterDirection.Input)              // 라인코드
                                                   , helper.CreateParameter("ErrorCode", drRow["ErrorCode"].ToString(), DbType.String, ParameterDirection.Input)            // 불량사유
