...
// *---------------------------------------------------------------------------------------------*                                                                                                  
//   Form ID      : BM3610                                                                                                                                                                          
//   Form Name    : 수입 검사항목 품목별 스펙 관리 (IN)                                                                                                                                                                    
//   Name Space   : WIZ.BM                                                                                                                                                                        
...
namespace WIZ.BM
{
    ...
    public partial class BM3610 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region BM3610_Load
        private void BM3610_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "PlantCode", "공장(사업장)", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);              // 공장                                              
            _GridUtil.InitColumnUltraGrid(grid1, "ItemCode", "품목", false, GridColDataType_emu.VarChar, 177, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);               // 품목                                                
            _GridUtil.InitColumnUltraGrid(grid1, "ItemName", "품목명", false, GridColDataType_emu.VarChar, 131, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);               // 품목명              
            _GridUtil.InitColumnUltraGrid(grid1, "InspCase", "검사구분", false, GridColDataType_emu.VarChar, 113, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);           // 검사구분                                             
            _GridUtil.InitColumnUltraGrid(grid1, "InspType", "검사대상", false, GridColDataType_emu.VarChar, 98, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);           // 검사유형     
            _GridUtil.InitColumnUltraGrid(grid1, "InspCode", "검사항목", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);           // 검사항목 
            _GridUtil.InitColumnUltraGrid(grid1, "InspName", "검사항목명", false, GridColDataType_emu.VarChar, 170, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);         // 검사항목명              
            _GridUtil.InitColumnUltraGrid(grid1, "DisplayNo", "표시순서", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);          // 표시순서                                                
            _GridUtil.InitColumnUltraGrid(grid1, "SpecLSL", "하한치", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);              // 하한치                                                  
            _GridUtil.InitColumnUltraGrid(grid1, "SpecUSL", "상한치", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);              // 상한치                                                  
            _GridUtil.InitColumnUltraGrid(grid1, "UnitCode", "단위", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);               // 단위               
            _GridUtil.InitColumnUltraGrid(grid1, "InspRequired", "검사필수여부", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);   // 검사필수여부                                            
            _GridUtil.InitColumnUltraGrid(grid1, "InspPeriod", "검사주기1", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);        // 검사주기(일/주/월)                                      
            _GridUtil.InitColumnUltraGrid(grid1, "InspCycle", "검사주기2", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);         // 검사주기(별)                                           
            _GridUtil.InitColumnUltraGrid(grid1, "InspMethod", "검사수집장비", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, true, null, null, null, null, null);     // 검사수집장비                                           
            _GridUtil.InitColumnUltraGrid(grid1, "InspCount", "검사횟수", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);          // 검사횟수                                             
            _GridUtil.InitColumnUltraGrid(grid1, "InspValType", "검사정보구분", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, true, null, null, null, null, null);    // 검사정보구분(양호/불량 OK/NOK 확인 값입력 
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MakerNM", "등록자명", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "EditorNM", "수정자명", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            */
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("InspCase", " MinorCode ='IN'");    //검사구분 수입검사)                                                                                                                                                                                 
            ...
            rtnDtTemp = _Common.GET_BM0130_CODE_1("I", "Y");  // 단위
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM3610_S1N", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)  // .GetChanges().Rows = 변경된 Rows 만 작업
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            //helper.ExecuteNoneQuery("USP_BM3610_D1N", CommandType.StoredProcedure, param);

                            //if (param[3].Value.ToString() == "E") throw new Exception(param[4].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM3610_D1N", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            //helper.ExecuteNoneQuery("USP_BM3610_I1N", CommandType.StoredProcedure, param);

                            //if (param[14].Value.ToString() == "E") throw new Exception(param[15].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM3610_I1N", CommandType.StoredProcedure
                                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("ItemCode", Convert.ToString(drRow["ItemCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            //helper.ExecuteNoneQuery("USP_BM3610_U1N", CommandType.StoredProcedure, param);

                            //if (param[14].Value.ToString() == "E") throw new Exception(param[15].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM3610_U1N", CommandType.StoredProcedure
                                                                     , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("ItemCode", Convert.ToString(drRow["ItemCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("DisplayNo", Convert.ToString(drRow["DisplayNo"]), DbType.String, ParameterDirection.Input)
