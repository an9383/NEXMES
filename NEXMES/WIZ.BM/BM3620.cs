...
// *----------------------------------------------------------------------------------------------*                                                                                                  
//   Form ID      : BM3620                                                                                                                                                                          
//   Form Name    : 공정 검사항목 품목별 스펙 관리 (QC)                                                                                                                                                                    
//   Name Space   : WIZ.BM                                                                                                                                                                        
...
namespace WIZ.BM
{
    ...
    public partial class BM3620 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        #region BM3620_Load
        private void BM3620_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            */
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("InspCase", " MinorCode ='QC'");    //검사구분 공정검사)                                                                                                                                                                                 
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM3620_S1N"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("USP_BM3620_D1N"
                                                    , CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3620_I1N"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)       // 공장코드
                                                    , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)       // 품목
                                                    , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)       // 검사항목코드
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3620_U1N"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)         // 공장코드
                                                   , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)           // 품목
                                                   , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)           // 검사항목코드
