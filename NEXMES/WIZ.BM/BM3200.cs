...
// *---------------------------------------------------------------------------------------------*                                                                                                  
//   Form ID      : BM3200                                                                                                                                                                          
//   Form Name    : 공정별 비가동 내역                                                                                                                                                                   
//   Name Space   : WIZ.BM                                                                                                                                                                        
//   Created Date : 2012-03-19 (2013-07-06 신규 재 개발)                                                                                                                                                                    
//   Made By      : WIZCORE                                                                                                                                                
//   Description  : 공정별로 발생가능 한 정보를 관리 한다                                                                                                                                                           
// *---------------------------------------------------------------------------------------------*                                                                                                  
#endregion
...
namespace WIZ.BM
{
    ...
    public partial class BM3200 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        public BM3200()
        {
            ...
            // grid pop-up 처리를 위한 정의 (OPCode(작업장 TBM0400),비가동유형
        ...
        #region BM3200_Load
        private void BM3200_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM3200_S1N", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3200_D1N"
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3200_I1N"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)            // 공장(사업장)
                                                    , helper.CreateParameter("OpCode", drRow["OpCode"].ToString(), DbType.String, ParameterDirection.Input)                  // 공정코드
                                                    , helper.CreateParameter("StopCode", drRow["StopCode"].ToString(), DbType.String, ParameterDirection.Input)              // 정지사유
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3200_U1N"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)            // 공장(사업장)
                                                    , helper.CreateParameter("OpCode", drRow["OpCode"].ToString(), DbType.String, ParameterDirection.Input)                 // 공정코드
                                                    , helper.CreateParameter("StopCode", drRow["StopCode"].ToString(), DbType.String, ParameterDirection.Input)              // 정지사유
