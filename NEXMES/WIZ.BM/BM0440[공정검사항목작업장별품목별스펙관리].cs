...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM0440
//   Form Name    : 공정검사항목 품목별 스펙관리
//   Name Space   : WIZ.BM
//   Created Date : 2018-01-09
//   Made By      : WIZCORE 남부사무소 사원 최수정
//   Edited Date  : 
//   Edit By      :
//   Description  : 공정 검사항목 작업장 스펙을 관리 
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0440 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0440_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INSPECT_SEQ", "순서", true, GridColDataType_emu.VarChar, 120, 130, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "ORDERSEQ", "정렬순서", true, GridColDataType_emu.Integer, 90, 100, Infragistics.Win.HAlign.Center, true, true);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "REMARK", "비고", true, GridColDataType_emu.VarChar, 200, 130, Infragistics.Win.HAlign.Center, true, true);
                ...
                grid1.DisplayLayout.Bands[0].Columns["INSPECT_SEQ"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                //GRID3 공정검사항목 (GRID3는 좌측 상단 세번쨰 GRID, GRID를 추가시 좌측상단부터 GRID 채번) (GRID EDITABLE 은 FALSE)
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0440_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
            ...
            {
                this.ClosePrgFormNew(); // GRID가 3개이므로 마지막으로 바인딩 되는 GRID 종료시 PrgForm Close
                helper.Close();
            }
        }
        /// <summary>
        ...
        public override void DoNew()
        {
            ...
            try
            {
                ...
                //GRID4의 정보
                this.grid1.ActiveRow.Cells["WORKCENTERCODE"].Value = DBHelper.nvlString(grid4.ActiveRow.Cells["WORKCENTERCODE"].Value);
                this.grid1.ActiveRow.Cells["WORKCENTERNAME"].Value = DBHelper.nvlString(grid4.ActiveRow.Cells["WORKCENTERNAME"].Value);
                //GRID3의 정보
                ...
                this.grid1.ActiveRow.Cells["ORDERSEQ"].Value = 0;

                //사용여부는 행 추가시 기본으로 세팅
                this.grid1.ActiveRow.Cells["USEFLAG"].Value = "Y";
                this.grid1.ActiveRow.Cells["VALUETYPE"].Value = "J";
                ...
                grid1.ActiveRow.Cells["ORDERSEQ"].Activation = Activation.AllowEdit;
            }
            catch (Exception ex)
            {
                this.ShowDialog(ex.Message, Forms.DialogForm.DialogType.OK);
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0440_D1"
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0440_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    ...
                                                    , helper.CreateParameter("AF_Excel_Caption", DBHelper.nvlString(drRow["Excel_Caption"]), DbType.String, ParameterDirection.Input)
                                                    ...
                                                    , helper.CreateParameter("AI_ORDERSEQ", DBHelper.nvlString(drRow["ORDERSEQ"]), DbType.Int32, ParameterDirection.Input)
                                                    );
                            #endregion
                            break;
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0440_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_INSPECT_SEQ", DBHelper.nvlString(drRow["INSPECT_SEQ"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_ITEMCODE", DBHelper.nvlString(drRow["ITEMCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0440_EXCEL bm0440_excel = new BM0440_EXCEL();
            bm0440_excel.ShowDialog();
        ...
        private void grid2_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0440_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_WORKCENTERCODE", sWorkCenterCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_INSPCODE", sInspCode, DbType.String, ParameterDirection.Input)
        ...
        private void grid1_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            byte[] bImage = GetImage(sPlantCode, sItemCode, sWorkCenterCode, sInspCode);
            ...
            if (drResult == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            helper2.ExecuteNoneQuery("USP_BM0440_U2", CommandType.StoredProcedure
        ...
        #region < METHOD AREA >
        private byte[] GetImage(string sPlantCode, string sItemCode, string sWorkcenterCode, string sInspCode)
        {
            byte[] bImage = null;
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_BM0440_S4", CommandType.StoredProcedure
                          , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("AS_WORKCENTERCODE", sWorkcenterCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("AS_INSPCODE", sInspCode, DbType.String, ParameterDirection.Input));
