...
namespace WIZ.BM
{
    public partial class BM1510 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        private void BM1510_Load(object sender, EventArgs e)
        {
            #region Grid1 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspDesc", "검사항목상세", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("INSPCASE", " MinorCode ='IN'");     // 검사구분            
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM1510_S1"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1510_D1"
                                                    , CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1510_I1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("InspCase", Convert.ToString(drRow["InspCase"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                     ...
                                                     //  , helper.CreateParameter("EditDate", DateTime.Now, DbType.DateTime, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1510_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("InspCase", Convert.ToString(drRow["InspCase"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("InspName", Convert.ToString(drRow["InspName"]), DbType.String, ParameterDirection.Input)
