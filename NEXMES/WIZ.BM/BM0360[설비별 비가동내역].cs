...
//   Edited Date  : 
//   Edit By      :
//   Description  : 설비(장비)별로 발생할수 있는 비가동을 관리
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0360 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0360_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING

                //GRID1 설비별 비가동내역 (GRID1은 우측에 위치한 MAIN GRID!)
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "STMACHCODE", "비가동코드", true, GridColDataType_emu.VarChar, 90, 90, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "STMACHDESC", "비가동명", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false);
                ...
                grid1.DisplayLayout.Bands[0].Columns["STMACHCODE"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "MACHCODE", "설비코드", true, GridColDataType_emu.VarChar, 100, 90, Infragistics.Win.HAlign.Center, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "STMACHCODE", "비가동코드", true, GridColDataType_emu.VarChar, 100, 90, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid3, "STMACHDESC", "비가동명", true, GridColDataType_emu.VarChar, 175, 100, Infragistics.Win.HAlign.Left, true, false);
                ...
                //비가동항목
                btbManager.PopUpAdd(txt_STMACHCODE_H, txt_STMACHDESC_H, "BM0110", new object[] { cbo_PLANTCODE_H, "", "" });
        ...
        public override void DoInquire()
        {
            ...
            string sStmachCode = DBHelper.nvlString(txt_STMACHCODE_H.Text.Trim());
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0360_S2", CommandType.StoredProcedure
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0360_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_STMACHCODE", sStmachCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_USEFLAG", sUseFlag, DbType.String, ParameterDirection.Input));
        ...
        public override void DoNew()
        {
            ...
            try
            {
                ...
                //GRID3의 정보
                this.grid1.ActiveRow.Cells["STMACHCODE"].Value = DBHelper.nvlString(grid3.ActiveRow.Cells["STMACHCODE"].Value);
                this.grid1.ActiveRow.Cells["STMACHDESC"].Value = DBHelper.nvlString(grid3.ActiveRow.Cells["STMACHDESC"].Value);
                ...
                grid1.ActiveRow.Cells["STMACHCODE"].Activation = Activation.NoEdit;
                grid1.ActiveRow.Cells["STMACHDESC"].Activation = Activation.NoEdit;
            ...
            try
            {
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    if (drRow.RowState != DataRowState.Deleted)
                    {
                        ...
                        if (Convert.ToString(drRow["STMACHCODE"]) == string.Empty)
                        {
                            this.ClosePrgFormNew();
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0360_I1"
                                                    ...
                                                    , helper.CreateParameter("AS_STMACHCODE", DBHelper.nvlString(drRow["STMACHCODE"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0360_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_MACHCODE", DBHelper.nvlString(drRow["MACHCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_STMACHCODE", DBHelper.nvlString(drRow["STMACHCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0360_EXCEL bm0360_excel = new BM0360_EXCEL();
            bm0360_excel.ShowDialog();
        ...
        private void grid2_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0360_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_MACHCODE", sMachCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_STMACHCODE", sStmachCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_USEFLAG", sUseFlag, DbType.String, ParameterDirection.Input));
