...
namespace WIZ.BM
{
    ...
    public partial class BM3600 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region BM3600_Load
        private void BM3600_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspCode", "검사항목", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);           // 검사항목 
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspCount", "검사횟수", true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);          // 검사횟수                                             
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                base.DoInquire();
                grid1.DataSource = helper.FillTable("USP_BM3600_S1N", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("USP_BM3600_D1N", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            #region 추가
                            helper.ExecuteNoneQuery("USP_BM3600_I1N", CommandType.StoredProcedure
                            , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)         // 공장코드
                            , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)           // 품목
                            , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)           // 검사항목코드
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM3600_U1N", CommandType.StoredProcedure
                            , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)         // 공장코드
                            , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)           // 품목
                            , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)           // 검사항목코드
                            , helper.CreateParameter("DisplayNo", drRow["DisplayNo"].ToString(), DbType.String, ParameterDirection.Input)         // 표시순서
