...
namespace WIZ.BM
{
    public partial class BM2200 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        public BM2200()
        {
            ...
            gridManager.PopUpAdd("WorkerID", "WorkerName", "TBM0200", new string[] { "PlantCode", "", "", "", "" });
        ...
        private void BM2200_Load(object sender, EventArgs e)
        {
            #region Grid1 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MachCode", "설비", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MachName", "설비명", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "WorkerID", "작업자ID", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "WorkerName", "작업자", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sMachCode = DBHelper.nvlString(this.cboMachCode_H.Value);
                string sWorkerID = txtWorkID.Text.Trim();
                string sUseFlag = DBHelper.nvlString(this.cboUseFlag_H.Value);

                grid1.DataSource = helper.FillTable("USP_BM2200_S1N", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2200_D1N", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2200_I1N", CommandType.StoredProcedure
                                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("MachCode", Convert.ToString(drRow["MachCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("WorkerID", Convert.ToString(drRow["WorkerID"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM2200_U1N", CommandType.StoredProcedure
                                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("MachCode", Convert.ToString(drRow["MachCode"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("WorkerID", Convert.ToString(drRow["WorkerID"]), DbType.String, ParameterDirection.Input)
                                                                    , helper.CreateParameter("UseFlag", Convert.ToString(drRow["UseFlag"]), DbType.String, ParameterDirection.Input)
