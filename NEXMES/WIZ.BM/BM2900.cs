...
// *---------------------------------------------------------------------------------------------*                                                                                                  
//   Form ID      : BM2900                                                                                                                                                                          
//   Form Name    : 설(장)비별 불량 내역                                                                                                                                                                   
//   Name Space   : WIZ.BM                                                                                                                                                                        
//   Created Date : 2012-03-19 (2013-07-05 신규 재 개발)                                                                                                                                                                    
//   Made By      : WIZCORE                                                                                                                                           
//   Description  : 설비별 발생가능 한 불량 정보를 관리 한다                                                                                                                                                           
// *---------------------------------------------------------------------------------------------*                                                                                                  
#endregion
...
namespace WIZ.BM
{
    ...
    public partial class BM2900 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        #region BM2900_Load
        private void BM2900_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "PlantCode", "공장(사업부)", false, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "MachCode", "설비코드", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "DisplayNo", "표시순번", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Right, true, true, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorType", "불량구분", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorClass", "불량유형", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorCode", "불량코드", false, GridColDataType_emu.VarChar, 130, 100, Infragistics.Win.HAlign.Center, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "ErrorDesc", "불량명", false, GridColDataType_emu.VarChar, 160, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM2900_S1N", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)  // .GetChanges().Rows = 변경된 Rows 만 작업
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            //param[1] = helper.CreateParameter("MachCode", drRow["MachCode"].ToString(), DbType.String, ParameterDirection.Input);             // 설비
                            //param[2] = helper.CreateParameter("ErrorCode", drRow["ErrorCode"].ToString(), DbType.String, ParameterDirection.Input);           // 불량코드
                            ...
                            //helper.ExecuteNoneQuery("USP_BM2900_D1N", CommandType.StoredProcedure, param);

                            //if (param[3].Value.ToString() == "E") throw new Exception(param[4].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM2900_D1N", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            //helper.ExecuteNoneQuery("USP_BM2900_I1N", CommandType.StoredProcedure, param);

                            //if (param[6].Value.ToString() == "E") throw new Exception(param[7].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM2900_I1N", CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("MachCode", Convert.ToString(drRow["MachCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("ErrorCode", Convert.ToString(drRow["ErrorCode"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            //helper.ExecuteNoneQuery("USP_BM2900_U1N", CommandType.StoredProcedure, param);

                            //if (param[6].Value.ToString() == "E") throw new Exception(param[7].Value.ToString());
                            helper.ExecuteNoneQuery("USP_BM2900_U1N", CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", Convert.ToString(drRow["PlantCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("MachCode", Convert.ToString(drRow["MachCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("ErrorCode", Convert.ToString(drRow["ErrorCode"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("DisplayNo", Convert.ToString(drRow["DisplayNo"]), DbType.String, ParameterDirection.Input)
