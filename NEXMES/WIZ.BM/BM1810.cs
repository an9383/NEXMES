...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM1810
//   Form Name    : 출하업체별 출하품목별 품목 단가  관리
//   Name Space   : WIZ.BM
...
namespace WIZ.BM
{
    public partial class BM1810 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        public BM1810()
        {
            ...
            bizGrid.PopUpAdd("CustCode", "CustName", "TBM0301", new string[] { "PlantCode", "C", "" });

            BizTextBoxManager btbManager = new BizTextBoxManager();

            btbManager.PopUpAdd(txtCustCode, txtCustName, "TBM0301", new object[] { cboPlantCode_H, "C", "" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM1810_S1"
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1810_D1"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)           // 공장코드
                                                   , helper.CreateParameter("CustCode", drRow["CustCode"].ToString(), DbType.String, ParameterDirection.Input)           // CustCode
                                                   , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)           // CustCode
                        ...
                        case DataRowState.Added:
                            ...
                            if (sStartDate == "")
                            {
                                MessageBox.Show(Common.getLangText("계시 시작 일자를 선택하세요", "MSG"));
                                return;
                            }

                            helper.ExecuteNoneQuery("USP_BM1810_I1"
                                                   , CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1810_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("CustCode", drRow["CustCode"].ToString(), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("ItemCode", drRow["ItemCode"].ToString(), DbType.String, ParameterDirection.Input)
        ...
        #region<BM1810_Load>
        private void BM1810_Load(object sender, EventArgs e)
        {
            #region 그리드
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "UseFlagNM", "사용유무", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Left, false, false, null, null, null, null, null);
