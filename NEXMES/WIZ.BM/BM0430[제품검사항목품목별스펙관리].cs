...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM0430
//   Form Name    : 제품검사항목 품목별 스펙관리
//   Name Space   : WIZ.BM
//   Created Date : 2018-01-09
//   Made By      : WIZCORE 남부사무소 사원 최수정
//   Edited Date  : 
//   Edit By      :
//   Description  : 제품 검사항목 품목별 스펙을 관리 
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0430 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0430_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                //검사항목
                btbManager.PopUpAdd(txt_INSPCODE_H, txt_INSPNAME_H, "BM0190", new object[] { cbo_PLANTCODE_H, cbo_USEFLAG_H });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0430_S2", CommandType.StoredProcedure
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0430_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0430_D1"
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0430_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_ITEMCODE", DBHelper.nvlString(drRow["ITEMCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPCODE", DBHelper.nvlString(drRow["INSPCODE"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0430_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_ITEMCODE", DBHelper.nvlString(drRow["ITEMCODE"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_INSPCODE", DBHelper.nvlString(drRow["INSPCODE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0430_EXCEL bm0430_excel = new BM0430_EXCEL();
            bm0430_excel.ShowDialog();
        ...
        private void grid2_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0430_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_INSPCODE", sInspCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_USEFLAG", sUseFlag, DbType.String, ParameterDirection.Input));
            ...
            if (drResult == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            helper2.ExecuteNoneQuery("USP_BM0430_U2", CommandType.StoredProcedure
        ...
        private byte[] GetImage(string sPlantCode, string sItemCode, string sInspCode)
        {
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_BM0430_S4", CommandType.StoredProcedure
                          , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("AS_ITEMCODE", sItemCode, DbType.String, ParameterDirection.Input)
                          , helper.CreateParameter("AS_INSPCODE", sInspCode, DbType.String, ParameterDirection.Input));
