...
namespace WIZ.BM
{
    public partial class BM1570 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        private void BM1570_Load(object sender, EventArgs e)
        {
            #region Grid1 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "InspCode", "점검항목코드", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "InspName", "점검항목", false, GridColDataType_emu.VarChar, 120, 30, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "InspDesc", "점검항목상세", false, GridColDataType_emu.VarChar, 150, 500, Infragistics.Win.HAlign.Center, true, true, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "InspType", "검사대상", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Center, false, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MakeDate", "등록일자", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "EditDate", "수정일자", false, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM1570_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1570_D1"
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1570_I1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM1570_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("InspCode", Convert.ToString(drRow["InspCode"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("InspName", Convert.ToString(drRow["InspName"]), DbType.String, ParameterDirection.Input)
                                                     , helper.CreateParameter("InspDesc", Convert.ToString(drRow["InspDesc"]), DbType.String, ParameterDirection.Input)
