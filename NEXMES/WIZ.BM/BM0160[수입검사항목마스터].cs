...
//   Edited Date  : 
//   Edit By      :
//   Description  : 자재 수입 검사 항목을 코드화 관리
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0160 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0160_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "INSPCODE", "검사코드", true, GridColDataType_emu.VarChar, 90, 90, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "INSPNAME", "검사항목명", true, GridColDataType_emu.VarChar, 150, 90, Infragistics.Win.HAlign.Left, true, true);
                ...
                //수입검사항목명
                btbManager.PopUpAdd(txt_INSPCODE_H, txt_INSPNAME_H, "BM0160", new object[] { cbo_PLANTCODE_H, "", "" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                string sInspName = DBHelper.nvlString(txt_INSPNAME_H.Text.Trim());
                string sUseFlag = DBHelper.nvlString(cbo_USEFLAG_H.Value);

                rtnDtTemp = helper.FillTable("USP_BM0160_S1", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                this.grid1.ActiveRow.Cells["INSPCODE"].Value = Common.getLangText("자동채번", "TEXT");
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0160_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0160_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPCODE", DBHelper.nvlString(drRow["INSPCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPNAME", DBHelper.nvlString(drRow["INSPNAME"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0160_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPCODE", DBHelper.nvlString(drRow["INSPCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPNAME", DBHelper.nvlString(drRow["INSPNAME"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0160_EXCEL bm0160_excel = new BM0160_EXCEL();
            bm0160_excel.ShowDialog();
