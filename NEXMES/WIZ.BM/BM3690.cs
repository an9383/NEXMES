...
// *---------------------------------------------------------------------------------------------*                                                                                                  
//   Form ID      : BM3690                                                                                                                                                                          
//   Form Name    : 금형 점검 항목별 스펙 관리                                                                                                                                                                    
//   Name Space   : WIZ.BM                                                                                                                                                                        
//   Created Date : 2012-03-19 (2013-07-03 신규 재 개발)                                                                                                                                                                    
//   Made By      : WIZCORE                                                                                                                                                
//   Description  : 모든 검사항목의  금형별 스펙을 관리                                                                                                                                                                
// *---------------------------------------------------------------------------------------------*                                                                                                  
#endregion
...
namespace WIZ.BM
{
    ...
    public partial class BM3690 : WIZ.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
        ...
        {
            InitializeComponent();
            // POP-UP 처리 필요 ( 조회창 : 금형, grid : 금형  검사항목 : InspCode)
            ...
            bizGrid.PopUpAdd("InspCode", "InspName", "TBM1500", new string[] { "InspCase", "", "Y" }); //TBM1500 : 검사항목 
        ...
        #region BM3690_Load
        private void BM3690_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MoldCode", "금형", true, GridColDataType_emu.VarChar, 177, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);               // 품목                                                
            _GridUtil.InitColumnUltraGrid(grid1, "MoldName", "금형명", true, GridColDataType_emu.VarChar, 131, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);               // 품목명              
            ...
            */
            ...
            rtnDtTemp = _Common.GET_BM0000_CODE("InspCase", " MinorCode ='MOLD'");    //검사구분 공정검사)                                                                                                                                                                                 
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                grid1.DataSource = helper.FillTable("USP_BM3690_S1"
        ...
        public override void DoNew()
        {
            try
            {
                ...
                UltraGridUtil.ActivationAllowEdit(this.grid1, "MoldCode");         // 품목                                                
                UltraGridUtil.ActivationAllowEdit(this.grid1, "MoldName");         // 품목명              
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    ...
                    {
                        if (drRow["MoldCode"].ToString().Trim() == "")
                        {
                            grid1.SetRowError(drRow, "금형 error!");
                            continue;
                        }
                    }
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("USP_BM3690_D1"
                                                    , CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3690_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)       // 공장코드
                                                    , helper.CreateParameter("MoldCode", drRow["MoldCode"].ToString(), DbType.String, ParameterDirection.Input)       // 금형코드
                                                    , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)       // 검사항목코드
                                                    , helper.CreateParameter("DisplayNo", drRow["DisplayNo"].ToString(), DbType.String, ParameterDirection.Input)       // 표시순서
                                                    , helper.CreateParameter("SpecLSL", drRow["SpecLSL"].ToString(), DbType.String, ParameterDirection.Input)       // 하한치
                                                    , helper.CreateParameter("SpecUSL", drRow["SpecUSL"].ToString(), DbType.String, ParameterDirection.Input)       // 상한치
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("USP_BM3690_U1"
                                                   , CommandType.StoredProcedure
                                                   , helper.CreateParameter("PlantCode", drRow["PlantCode"].ToString(), DbType.String, ParameterDirection.Input)           // 공장코드
                                                   , helper.CreateParameter("MoldCode", drRow["MoldCode"].ToString(), DbType.String, ParameterDirection.Input)           // 금형코드
                                                   , helper.CreateParameter("InspCode", drRow["InspCode"].ToString(), DbType.String, ParameterDirection.Input)           // 검사항목코드
                ...
                grid1.SetAcceptChanges("MoldCode");
                helper.Commit();
