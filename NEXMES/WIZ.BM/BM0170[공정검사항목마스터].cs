...
namespace WIZ.BM
{
    public partial class BM0170 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0170_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                //공정검사항목명
                btbManager.PopUpAdd(txt_INSPCODE_H, txt_INSPNAME_H, "BM0170", new object[] { cbo_PLANTCODE_H, "", "" });
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0170_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            ...
                            helper.ExecuteNoneQuery("USP_BM0170_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0170_I1"
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0170_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPCODE", DBHelper.nvlString(drRow["INSPCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_INSPNAME", DBHelper.nvlString(drRow["INSPNAME"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0170_EXCEL bm0170_excel = new BM0170_EXCEL();
            bm0170_excel.ShowDialog();
