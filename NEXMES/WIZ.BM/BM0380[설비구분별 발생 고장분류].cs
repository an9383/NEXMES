...
// *---------------------------------------------------------------------------------------------*
//   Form ID      : BM0380
//   Form Name    : 설비구분별 발생 고장분류
//   Name Space   : WIZ.BM
//   Created Date : 2018-01-09
//   Made By      : WIZCORE 남부사무소 사원 김병수
//   Edited Date  : 
//   Edit By      :
//   Description  : 설비(장비) 타입별로 고장유형을 연결 관리
// *---------------------------------------------------------------------------------------------*
#endregion
...
namespace WIZ.BM
{
    public partial class BM0380 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void BM0380_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING

                //GRID1 설비구분별 발생 고장분류 (GRID1은 우측에 위치한 MAIN GRID!)
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "MACHTYPE", "설비구분", true, GridColDataType_emu.VarChar, 130, 90, Infragistics.Win.HAlign.Left, true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "FAILURETYPE", "고장분류", true, GridColDataType_emu.VarChar, 130, 90, Infragistics.Win.HAlign.Left, true, false);
                //_GridUtil.InitColumnUltraGrid(grid1, "FAILURECODE", "고장코드",  true, GridColDataType_emu.VarChar,   90,  90, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid1, "FAILURENAME", "고장명",    true, GridColDataType_emu.VarChar,  150, 100, Infragistics.Win.HAlign.Left,   true, false);
                ...
                grid1.DisplayLayout.Bands[0].Columns["FAILURETYPE"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                _GridUtil.InitColumnUltraGrid(grid2, "MACHTYPE", "설비구분", true, GridColDataType_emu.VarChar, 170, 90, Infragistics.Win.HAlign.Left, true, false);
                //_GridUtil.InitColumnUltraGrid(grid2, "MACHCODE",  "설비코드", true, GridColDataType_emu.VarChar,  90,  90, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid2, "MACHNAME",  "설비명",   true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left,   true, false);
                ...
                _GridUtil.InitColumnUltraGrid(grid3, "FAILURETYPE", "고장분류", true, GridColDataType_emu.VarChar, 170, 90, Infragistics.Win.HAlign.Left, true, false);
                //_GridUtil.InitColumnUltraGrid(grid3, "FAILURECODE", "고장코드", true, GridColDataType_emu.VarChar,  90,  90, Infragistics.Win.HAlign.Center, true, false);
                //_GridUtil.InitColumnUltraGrid(grid3, "FAILURENAME", "고장명",   true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left,   true, false);
                ...
                rtnDtTemp = _Common.GET_BM0000_CODE("MACHTYPE"); //설비구분
                ...
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid2, "MACHTYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");
                ...
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid3, "FAILURETYPE", rtnDtTemp, "CODE_ID", "CODE_NAME");
                ...
                ////고장항목
                //btbManager.PopUpAdd(txt_FAILURECODE_H, txt_FAILURENAME_H, "BM0370", new object[] { cbo_PLANTCODE_H, "", "" });
        ...
        public override void DoInquire()
        {
            ...
            string sFailureType = DBHelper.nvlString(cbo_FAILURETYPE_H.Text.Trim());
            //string sFailureCode  = DBHelper.nvlString(txt_FAILURECODE_H.Text.Trim());
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0380_S2", CommandType.StoredProcedure
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM0380_S3", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
        ...
        public override void DoNew()
        {
            ...
            {
                this.ShowDialog(Common.getLangText("설비구분을 선택해주세요.", "MSG"), Forms.DialogForm.DialogType.OK);
                return;
            }
            else if (grid3.ActiveRow == null)
            {
                this.ShowDialog(Common.getLangText("고장분류를 선택해주세요.", "MSG"), Forms.DialogForm.DialogType.OK);
                return;
            }
            ...
            try
            {
                ...
                this.grid1.ActiveRow.Cells["MACHTYPE"].Value = DBHelper.nvlString(grid2.ActiveRow.Cells["MACHTYPE"].Value);
                ...
                //GRID3의 정보
                this.grid1.ActiveRow.Cells["FAILURETYPE"].Value = DBHelper.nvlString(grid3.ActiveRow.Cells["FAILURETYPE"].Value);
                //this.grid1.ActiveRow.Cells["FAILURECODE"].Value  = DBHelper.nvlString(grid3.ActiveRow.Cells["FAILURECODE"].Value);
                //this.grid1.ActiveRow.Cells["FAILURENAME"].Value  = DBHelper.nvlString(grid3.ActiveRow.Cells["FAILURENAME"].Value);
                ...
                grid1.ActiveRow.Cells["MACHTYPE"].Activation = Activation.NoEdit;
                //grid1.ActiveRow.Cells["MACHCODE"].Activation = Activation.NoEdit;
                //grid1.ActiveRow.Cells["MACHNAME"].Activation = Activation.NoEdit;
                grid1.ActiveRow.Cells["FAILURETYPE"].Activation = Activation.NoEdit;
                //grid1.ActiveRow.Cells["FAILURECODE"].Activation = Activation.NoEdit;
                //grid1.ActiveRow.Cells["FAILURENAME"].Activation = Activation.NoEdit;
            ...
            try
            {
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    if (drRow.RowState != DataRowState.Deleted)
                    {
                        ...
                        if (Convert.ToString(drRow["MACHTYPE"]) == string.Empty)
                        {
                            this.ClosePrgFormNew();
                            this.ShowDialog(Common.getLangText("설비구분은 필수 입력항목입니다..", "MSG"), Forms.DialogForm.DialogType.OK);
                            return;
                        }
                        if (Convert.ToString(drRow["FAILURETYPE"]) == string.Empty)
                        {
                            this.ClosePrgFormNew();
                            this.ShowDialog(Common.getLangText("고장분류는 필수 입력항목입니다..", "MSG"), Forms.DialogForm.DialogType.OK);
                            return;
                        }
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0380_I1"
                                                    ...
                                                    //, helper.CreateParameter("AS_FAILURECODE", DBHelper.nvlString(drRow["FAILURECODE"]), DbType.String,   ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_FAILURETYPE", DBHelper.nvlString(drRow["FAILURETYPE"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0380_U1"
                                                     , CommandType.StoredProcedure
                                                     , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                     //, helper.CreateParameter("AS_MACHCODE",    DBHelper.nvlString(drRow["MACHCODE"]),    DbType.String,   ParameterDirection.Input)
                                                     , helper.CreateParameter("AS_MACHTYPE", DBHelper.nvlString(drRow["MACHTYPE"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0380_EXCEL bm0380_excel = new BM0380_EXCEL();
            bm0380_excel.ShowDialog();
        ...
        private void grid2_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            //GRID1 설비구분별 발생 고장분류 조회
            try
            {
                //GRID2에서 정보 GET
                string sPlantCode = DBHelper.nvlString(grid2.ActiveRow.Cells["PLANTCODE"].Value);
                string sMachType = DBHelper.nvlString(grid2.ActiveRow.Cells["MACHTYPE"].Value);
                //string sMachCode  = DBHelper.nvlString(grid2.ActiveRow.Cells["MACHCODE"].Value);
                string sUseFlag = DBHelper.nvlString(cbo_USEFLAG_H.Value);

                //조회조건에서 정보 GET
                string sFailureType = DBHelper.nvlString(cbo_FAILURETYPE_H.Value);
                //string sFailureCode = DBHelper.nvlString(txt_FAILURECODE_H.Text.Trim());



                rtnDtTemp = helper.FillTable("USP_BM0380_S1", CommandType.StoredProcedure
                                                            , helper.CreateParameter("AS_PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_MACHTYPE", sMachType, DbType.String, ParameterDirection.Input)
                                                            //, helper.CreateParameter("AS_MACHCODE",    sMachCode,    DbType.String, ParameterDirection.Input)
                                                            , helper.CreateParameter("AS_FAILURETYPE", sFailureType, DbType.String, ParameterDirection.Input)
