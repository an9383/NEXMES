...
namespace WIZ.BM
{
    public partial class BM5100 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_BM5100_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("USP_BM5100_I1"
                                                    , CommandType.StoredProcedure
        ...
        public override void DoImportExcel()
        {
            ...
            //BM5100_EXCEL BM5100_excel = new BM5100_EXCEL();
            //BM5100_excel.ShowDialog();
