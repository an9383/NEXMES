...
namespace WIZ.BM
{
    public partial class DG0000 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void DG0000_Load(object sender, EventArgs e)
        {
            try
            {
                #region GRID SETTING
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "KEY_NO", "키NO", true, GridColDataType_emu.Integer, 50, 100, Infragistics.Win.HAlign.Center, true, false);
                _GridUtil.InitColumnUltraGrid(grid1, "TABLE_NAME", "테이블명", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CODE", "코드", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Left, true, true);

                _GridUtil.InitColumnUltraGrid(grid1, "REMARK", "비고", true, GridColDataType_emu.VarChar, 100, 130, Infragistics.Win.HAlign.Left, true, true);
                ...
                grid1.DisplayLayout.Bands[0].Columns["KEY_NO"].Header.Appearance.ForeColor = Color.SkyBlue;
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("USP_DG0000_S1", CommandType.StoredProcedure
        ...
        public override void DoNew()
        {
            try
            {
                ...
                grid1.ActiveRow.Cells["KEY_NO"].Activation = Activation.NoEdit;
                ...
                //this.grid1.ActiveRow.Cells["KEY_NO"].Value = Common.getLangText("자동채번", "TEXT");
            ...
            try
            {
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    if (drRow.RowState != DataRowState.Deleted)
                    {
                        ...
                        {
                            this.ClosePrgFormNew();
                            //grid1.SetRowError(drRow, Common.getLangText("사업장은 필수 입력항목입니다.", "TEXT"));
                        ...
                        {
                            this.ClosePrgFormNew();
                            //grid1.SetRowError(drRow, Common.getLangText("분류NO는 필수 입력항목입니다.", "TEXT"));
                    ...
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제   
                            drRow.RejectChanges();  //2020-09-10 add

                            helper.ExecuteNoneQuery("USP_DG0000_D1"
                                                    ...
                                                    , helper.CreateParameter("KEY_NO", DBHelper.nvlString(drRow["KEY_NO"]), DbType.Int32, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 추가 또는 수정
                            helper.ExecuteNoneQuery("USP_DG0000_SAVE1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("TYPE_NO", DBHelper.nvlString(drRow["TYPE_NO"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("KEY_NO", DBHelper.nvlString(drRow["KEY_NO"]), DbType.Int32, ParameterDirection.Input)
                                                    , helper.CreateParameter("TABLE_NAME", DBHelper.nvlString(drRow["TABLE_NAME"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("CODE", DBHelper.nvlString(drRow["CODE"]), DbType.String, ParameterDirection.Input)
                    ...
                    grid1.SetRowError(drRow, helper.RSMSG, helper.RSCODE);  //2020-09-10
                }
        ...
        private void DG0000_Activated(object sender, EventArgs e)
        {
            //2020-09-14 ADD
            try
            {
