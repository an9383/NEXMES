...
namespace WIZ.BM
{
    public partial class BM0500 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void BM0500_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "CARNO", "차량번호", true, GridColDataType_emu.VarChar, 90, 100, Infragistics.Win.HAlign.Center, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARDESC", "차량내역", true, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARGUBUN", "자차구분", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARWGT", "차량중량", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CAREMPWGT", "공차중량", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARMAXWGT", "최대적재중량", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CUSTCODE", "용차업체", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARCLASS", "차종", true, GridColDataType_emu.VarChar, 200, 100, Infragistics.Win.HAlign.Left, true, true);
                _GridUtil.InitColumnUltraGrid(grid1, "CARMAKER", "제조사", true, GridColDataType_emu.VarChar, 120, 100, Infragistics.Win.HAlign.Left, true, true);
                ...
                grid1.DisplayLayout.Bands[0].Columns["CARNO"].Header.Appearance.ForeColor = Color.SkyBlue;
                ...
                cbo_PLANTCODE_H.Value = sPlantCode;
                ...
                WIZ.UltraGridUtil.SetComboUltraGrid(this.grid1, "CARCLASS", rtnDtTemp, "CODE_ID", "CODE_NAME");
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                string sCarGubun = DBHelper.nvlString(cbo_CARGUBUN_H.Value);
                string sUseFlag = DBHelper.nvlString(cbo_USEFLAG_H.Value);

                rtnDtTemp = helper.FillTable("USP_BM0500_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in rtnDtTemp.Rows)
                {
                    ...
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Added:
                            #region 추가                            
                            helper.ExecuteNoneQuery("USP_BM0500_I1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARNO", DBHelper.nvlString(drRow["CARNO"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARDESC", DBHelper.nvlString(drRow["CARDESC"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARGUBUN", DBHelper.nvlString(drRow["CARGUBUN"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARWGT", DBHelper.nvlString(drRow["CARWGT"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CAREMPWGT", DBHelper.nvlString(drRow["CAREMPWGT"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARMAXWGT", DBHelper.nvlString(drRow["CARMAXWGT"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CUSTCODE", DBHelper.nvlString(drRow["CUSTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARCLASS", DBHelper.nvlString(drRow["CARCLASS"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARMAKER", DBHelper.nvlString(drRow["CARMAKER"]), DbType.String, ParameterDirection.Input)
                        ...
                        case DataRowState.Modified:
                            #region 수정
                            helper.ExecuteNoneQuery("USP_BM0500_U1"
                                                    , CommandType.StoredProcedure
                                                    , helper.CreateParameter("AS_PLANTCODE", DBHelper.nvlString(drRow["PLANTCODE"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARNO", DBHelper.nvlString(drRow["CARNO"]), DbType.String, ParameterDirection.Input)
                                                    , helper.CreateParameter("AS_CARDESC", DBHelper.nvlString(drRow["CARDESC"]), DbType.String, ParameterDirection.Input)
        ...
        public override void DoImportExcel()
        {
            ...
            BM0500_EXCEL bm0500_excel = new BM0500_EXCEL();
            bm0500_excel.ShowDialog();
