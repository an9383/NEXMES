...
namespace WIZ.PopUp
{
    public partial class MD0005_POP1 : WIZ.Forms.BasePopupForm
    {
        ...
        public MD0005_POP1(string sCORECODE)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "MOLDCODE", "금형코드", false, GridColDataType_emu.VarChar, 120, 120, Infragistics.Win.HAlign.Left, false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMCODE", "품목코드", false, GridColDataType_emu.VarChar, 150, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "ITEMNAME", "품목명", false, GridColDataType_emu.VarChar, 220, 120, Infragistics.Win.HAlign.Left, true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "chk_MOLDCODE", "금형코드", false, GridColDataType_emu.VarChar, 120, 120, Infragistics.Win.HAlign.Left, false, false);
            _GridUtil.InitColumnUltraGrid(grid2, "chk_MOLDNAME", "금형명", false, GridColDataType_emu.VarChar, 150, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "chk_DEGREE", "차수", false, GridColDataType_emu.VarChar, 50, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "chk_ITEMCODE", "품목코드", false, GridColDataType_emu.VarChar, 150, 120, Infragistics.Win.HAlign.Left, true, false);
            _GridUtil.InitColumnUltraGrid(grid2, "chk_ITEMNAME", "품목명", false, GridColDataType_emu.VarChar, 220, 120, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void btn_SAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    helper.ExecuteNoneQuery("USP_MD0005_POP_SAVE", CommandType.StoredProcedure
                        , helper.CreateParameter("AS_MOLDCODE", DBHelper.nvlString(grid2.Rows[grid1rowNUM].Cells["chk_MOLDCODE"].Value), DbType.String, ParameterDirection.Input)
            ...
            try
            {
                ...
                for (int grid1rowNUM = 0; grid1rowNUM < grid1.Rows.Count; grid1rowNUM++)
                {
                    if (grid1.Rows[grid1rowNUM].Cells["CHK"].Value.ToString().ToUpper() == "TRUE")
                    {
                        ...
                        grid2.Rows[iRow].Cells["chk_MOLDCODE"].Value = DBHelper.nvlString(grid1.Rows[grid1rowNUM].Cells["MOLDCODE"].Value);
                        grid2.Rows[iRow].Cells["chk_MOLDNAME"].Value = DBHelper.nvlString(grid1.Rows[grid1rowNUM].Cells["MOLDNAME"].Value);
                        grid2.Rows[iRow].Cells["chk_DEGREE"].Value = DBHelper.nvlString(grid1.Rows[grid1rowNUM].Cells["DEGREE"].Value);
