...
namespace WIZ.MD
{
    public partial class MD0050_TEST : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void MD0050_TEST_Load(object sender, EventArgs e)
        {
            #region GRID SETTING 
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "RP_Workdate",       "당일기준재고",   true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true);
        ...
        private void btn_Initem_Click_1(object sender, EventArgs e)
        {
