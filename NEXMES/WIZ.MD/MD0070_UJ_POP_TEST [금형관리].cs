...
namespace WIZ.MD
{
    public partial class MD0002_UJ : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void txtBARCODE_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dtBARCORE = helper.FillTable("USP_MD0002_UJ_SEL", CommandType.StoredProcedure
                    , helper.CreateParameter("AS_MOLDCODE", txtBARCODE.Text, DbType.String, ParameterDirection.Input));
                
                SetMoldInfo(dtBARCORE);
            }
        }
    }
}
