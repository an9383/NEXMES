...
namespace WIZ.MD
{
    public partial class MD0060_POP2 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void btnSAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.ExecuteNoneQuery("USP_MD0060_POP2_I", CommandType.StoredProcedure
                    ...
                    , helper.CreateParameter("AS_GUBUN", "이관", DbType.String, ParameterDirection.Input)
