...
namespace WIZ.MD
{
    public partial class MD0005_UJ : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void GridInitialize()
        {
            try
            {
                ...
                _GridUtil.InitColumnUltraGrid(grid1, "Core_Cost",       "단가",           true, GridColDataType_emu.VarChar, 100, 100, Infragistics.Win.HAlign.Left, true, false);
        ...
        private void btn_ADDCORE_Click(object sender, EventArgs e)
        {

        }

        private void btn_MNCORE_Click(object sender, EventArgs e)
        {

        }

        private void btn_CHANGECORE_Click(object sender, EventArgs e)
        {
