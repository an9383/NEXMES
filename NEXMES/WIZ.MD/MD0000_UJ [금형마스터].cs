...
namespace WIZ.MD
{
    public partial class MD0000_UJ : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void BtnProd_Click(object sender, EventArgs e)
        {
            try
            {
                MD0000_BM0010_POP MD0000_BM0010_POP = new MD0000_BM0010_POP(txtMOLDCODE.Text.Trim());
                MD0000_BM0010_POP.Show();
            }
            catch
            {
