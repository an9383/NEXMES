...
namespace WIZ.MD
{
    public partial class MD0070 : WIZ.Forms.BaseMDIChildForm
    {
        ...
        #region < FORM LOAD >
        private void MD0070_TEST_Load(object sender, EventArgs e)
        {
            #region GRID SETTING  
            _GridUtil.InitializeGrid(this.grid1, true, true, false, "", false);

            _GridUtil.InitColumnUltraGrid(grid1, "RP_date",         "수리입고일자",      true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_Vend",         "고객사",            true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드           
            _GridUtil.InitColumnUltraGrid(grid1, "RP_PartName",     "제품명",            true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드           
            _GridUtil.InitColumnUltraGrid(grid1, "RP_MDCode",       "금형코드",          true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 콤보박스로 보여준다. (바코드)
            _GridUtil.InitColumnUltraGrid(grid1, "RP_ChaSu",        "차수",              true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_Workdate",     "작업일자",          true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_WorkGB",       "작업구분",          true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_USMS",         "유무상",            true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_Cost",         "비용",              true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_MD_CVT",       "금형Cavity",        true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_MD_CVT_No",    "금형Cavity No.",    true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_PT_CVT",       "제품Cavity",        true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_PT_CVT_No",    "제품Cavity No.",    true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_NW_CVT",       "현재Cavity",        true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_NW_CVT_No",    "현재Cavity No.",    true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_NW_Shot",      "현재 Shot",         true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_TT_Shot",      "누적 Shot",         true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_MakingGB",     "제작구분",          true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 바코드
            _GridUtil.InitColumnUltraGrid(grid1, "RP_CoreUseg",     "코어사용이력",      true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 0
            _GridUtil.InitColumnUltraGrid(grid1, "RP_RepairList",   "수리사항",          true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
            _GridUtil.InitColumnUltraGrid(grid1, "RP_ETC1",         "비고",              true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
        ...
        private void grid1_DoubleClickCell(object sender, DoubleClickCellEventArgs e)
        {
            ...
            { 
                MD0070_POP1 MDP = new MD0070_POP1(sMoldCode);
                MDP.Show();
            }
        }
