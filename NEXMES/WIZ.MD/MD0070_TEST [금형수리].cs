...
namespace WIZ.MD
{
    public partial class MD0070_TEST : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        private void MD0070_TEST_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "RP_Time",         "수리입고시간",      true, GridColDataType_emu.VarChar,      100, 100, Infragistics.Win.HAlign.Left,   true, true); // 사용자 입력
