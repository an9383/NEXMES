...
namespace WIZ.ETC
{
    public partial class ET0600_POP : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void ET0600_POP_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >

            cbo_GUBUN.Items.Add("1호기");
            cbo_GUBUN.Items.Add("2호기");
            cbo_GUBUN.Items.Add("3호기");
            cbo_GUBUN.Items.Add("4호기");
            cbo_GUBUN.Items.Add("5호기");
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_ET0600_POP_S2", CommandType.StoredProcedure
