...
namespace WIZ.ETC
{
    public partial class ET0600 : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void ET0600_Load(object sender, EventArgs e)
        {
            #region GRID SETTING  
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ds = helper.FillDataSet("USP_PL0000_S1", CommandType.StoredProcedure
                    , helper.CreateParameter("AS_PLANTCODE", cbo_PLANTCODE_H.Text, DbType.String, ParameterDirection.Input)
                    , helper.CreateParameter("AS_Startdate", DTP1.Text, DbType.String, ParameterDirection.Input)
                    , helper.CreateParameter("AS_Enddate", DTP2.Text, DbType.String, ParameterDirection.Input)
