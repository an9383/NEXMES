...
namespace WIZ.ETC
{
    public partial class ET0610_POP : WIZ.Forms.BaseMDIChildForm
    {
        #region < MEMBER AREA >
        ...
        #region < FORM LOAD >
        private void ET0610_POP_Load(object sender, EventArgs e)
        {
            #region < GRID SETTING >
            ...
            try
            {
                rtnDtTemp = helper.FillTable("USP_ET0610_POP_S2", CommandType.StoredProcedure
