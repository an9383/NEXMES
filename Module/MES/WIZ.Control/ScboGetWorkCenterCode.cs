...
{
    public class ScboGetWorkCenterCode : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetWorkCenterCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("PlantCode ", (PlantCode == null) ? "" : PlantCode, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
