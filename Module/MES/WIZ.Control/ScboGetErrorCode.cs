...
{
    public class ScboGetErrorCode : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetErrorCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("ErrorType", (errorType == null) ? "" : errorType, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("ErrorClass", (errorClass == null) ? "" : errorClass, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["ErrorCode"].Hidden = true;
