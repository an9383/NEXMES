...
{
    public class ScboGetWorker : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetWorker_S", CommandType.StoredProcedure, dBHelper.CreateParameter("OPCode ", (opcode == null) ? "" : opcode, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("LineCode ", (linecode == null) ? "" : linecode, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("WorkCenterCode ", (workcentercode == null) ? "" : workcentercode, DbType.String, ParameterDirection.Input), dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
