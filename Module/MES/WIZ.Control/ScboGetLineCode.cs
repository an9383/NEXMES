...
{
    public class ScboGetLineCode : UltraCombo
    {
        ...
        public void InitComboBox()
        {
            ...
            try
            {
                base.DataSource = dBHelper.FillTable("USP_ScboGetLineCode_S", CommandType.StoredProcedure, dBHelper.CreateParameter("CboType", (cboType == ComboDataType.All) ? "ALL" : "", DbType.String, ParameterDirection.Input));
                DataBind();
                base.DisplayLayout.AutoFitStyle = AutoFitStyle.ExtendLastColumn;
                base.DisplayLayout.Bands[0].Columns["LineCode"].Hidden = true;
